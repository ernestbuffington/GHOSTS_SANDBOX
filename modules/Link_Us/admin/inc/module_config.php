...
echo "<table width='80%' border='1' style='margin: auto;'><tr><th scope='col'>".$lang_new[$nuke_module_name]['MODULE_CONFIG']."</th></tr></table>";
...
echo "  <tr>";
echo "    <td width='40%'><strong>".$lang_new[$nuke_module_name]['SHOW_STANDARD'].":</strong></td>";
echo "    <td width='40%'>";
echo yesno_option('button_standard', $nuke_config['button_standard']);
echo "    </td>";
echo "  </tr>";
echo "  <tr>";
echo "    <td width='40%'><strong>".$lang_new[$nuke_module_name]['SHOW_BANNER'].":</strong></td>";
echo "    <td width='40%'>";
echo yesno_option('button_banner', $nuke_config['button_banner']);
echo "    </td>";
echo "  </tr>";
echo "  <tr>";
echo "    <td width='40%'><strong>".$lang_new[$nuke_module_name]['SHOW_RESOURCES'].":</strong></td>";
echo "    <td width='40%'>";
...
echo "<br /><div align='center'><input name='submit' type='submit' value='".$lang_new[$nuke_module_name]['UPDATE_MODULE_CONFIG']."' /></div>";
echo "</form>";
