...
echo '<div align="center"><img src="modules/'.$nuke_module_name.'/images/linkus-logo.png"></div>';
...
if ($nuke_config['button_standard'] == 1){
    ...
    if($numrows == 0)
	{
        echo '<div align="center"><span color="red" size="3">!'.$lang_new[$nuke_module_name]['NO_ACTIVE_SITES'].'!</span></div>';
    } 
	else 
	{
        if ($numrows > 0) 
		{
		    ...
		    while(list($id, $site_name, $site_url, $site_image, $site_description, $site_hits, $site_status, $date_added) = $nuke_db->sql_fetchrow($result)) 
			{
				...
				<a href="modules.php?name='.$nuke_module_name.'&amp;op=visit&amp;id='.$id.'" target="_blank"><i class="bi bi-link"></i></i> '.set_smilies(decode_bbcode(stripslashes($site_name), 1, true)).' <i class="bi bi-link"></i></i></a></legend>';				
                ...
                print "<td rowspan=\"2\" width=\"110\" align=\"center\" valign=\"top\"><a href='modules.php?name=".$nuke_module_name."&amp;op=visit&amp;id=".$id."' target='_blank'><img height=\"31\" src='".$site_image."' ".$settings." /></a></a>";

                if (is_mod_admin($nuke_module_name)) 
				{
                echo "<br /><a href='".$admin_file.".php?op=edit_button&amp;
                id=".$id."'><img src='modules/".$nuke_module_name."/images/edit.png' border='0' 
                alt='".$lang_new[$nuke_module_name]['EDIT']."' title='".$lang_new[$nuke_module_name]['EDIT']."' /></a>";
                echo " <a href='".$admin_file.".php?op=delete_button&amp;id=".$id."'><img 
                src='modules/".$nuke_module_name."/images/delete.png' 
				border='0' alt='".$lang_new[$nuke_module_name]['DELETE']."' title='".$lang_new[$nuke_module_name]['DELETE']."' /></a>";
                }

               print '</td><td align="left" valign="top" height="3" width="80%"><strong>&nbsp;<i class="bi bi-calendar2-check"></i>&nbsp; '.$lang_new[$nuke_module_name]['ADDED'].' '.formatTimestamp($date_added).'</strong></td>';
               print '</tr>';
               print '<tr>';
               
			   print '<td align="left" valign="top" height="3" width="0">';
			   print '<strong>&nbsp;<i class="bi bi-eye"></i>&nbsp; '.$lang_new[$nuke_module_name]['VISITS'].': '.$site_hits.'</strong></td>';
			   print '</tr>';
...
if ($nuke_config['button_banner'] == 1){
    ...
    if ($numrows > 0) {
        ...
        echo "<tr><th width='100%'>".$lang_new[$nuke_module_name]['BANNER_BUTTONS']."</th></tr>";
        ...
        while(list($id, $site_name, $site_url, $site_image, $site_description, $site_hits, $site_status, $date_added) = $nuke_db->sql_fetchrow($result)) {
            ...
            echo "<a href='modules.php?name=".$nuke_module_name."&amp;op=visit&amp;id=$id' target='_blank'><img src='".$site_image."' ".$settings." /></a>";
            if (is_mod_admin($nuke_module_name)) {
                echo "<br /><br /><a href='".$admin_file.".php?op=edit_button&amp;id=".$id."'><img src='modules/".$nuke_module_name."/images/edit.png' border='0' alt='".$lang_new[$nuke_module_name]['EDIT']."' title='".$lang_new[$nuke_module_name]['EDIT']."' /></a>";
                echo " <a href='".$admin_file.".php?op=delete_button&amp;id=".$id."'><img src='modules/".$nuke_module_name."/images/delete.png' border='0' alt='".$lang_new[$nuke_module_name]['DELETE']."' title='".$lang_new[$nuke_module_name]['DELETE']."' /></a>";
            }
            echo "</td><td width='75%' valign='top'>";
            echo "<table border='0' width='100%'>";
            echo "<tr><td valign='top' align='left'><strong>".$lang_new[$nuke_module_name]['SITE_NAME'].":</strong></td><td>".set_smilies(decode_bbcode(stripslashes($site_name), 1, true))."</td></tr>";
            echo "<tr><td valign='top' align='left'><strong>".$lang_new[$nuke_module_name]['ADDED'].":</strong></td><td>".formatTimestamp($date_added)."</td></tr>";
            echo "<tr><td valign='top' align='left'><strong>".$lang_new[$nuke_module_name]['VISITS'].":</strong></td><td>".$site_hits."</td></tr>";
            echo "<tr><td valign='top' align='left'><strong>".$lang_new[$nuke_module_name]['DESCRIPTION'].":</strong></td><td>".set_smilies(decode_bbcode(stripslashes($site_description),1, true))."</td></tr>";
            echo "</table></td>";
            echo "</tr></table>";
            CloseTable();
            echo "</td>";
...
if ($nuke_config['button_resource'] == 1){
    ...
    if ($numrows > 0) {
        echo "<br /><br />";
        echo "<table border='0' cellpadding='2' cellspacing='5' width='100%' align='center'>";
        echo "<tr><th width='100%'>".$lang_new[$nuke_module_name]['RESOURCES']."</th></tr>";
        echo "</table>";
        echo "<table border='0' cellpadding='2' cellspacing='5' width='100%'>";
        while(list($id, $site_name, $site_url, $site_image, $site_description, $site_hits, $site_status, $date_added) = $nuke_db->sql_fetchrow($result)) {
            if ($num == 0) { echo "<tr>"; }
            ...
            echo "<a href='modules.php?name=".$nuke_module_name."&amp;op=visit&amp;id=$id' target='_blank'><img src='".$site_image."' ".$settings." align='absmiddle' /></a>";
            if (is_mod_admin($nuke_module_name)) {
                echo "<br /><br /><a href='".$admin_file.".php?op=edit_button&amp;id=".$id."'><img src='modules/".$nuke_module_name."/images/edit.png' border='0' alt='".$lang_new[$nuke_module_name]['EDIT']."' title='".$lang_new[$nuke_module_name]['EDIT']."' /></a>";
                echo " <a href='".$admin_file.".php?op=delete_button&amp;id=".$id."'><img src='modules/".$nuke_module_name."/images/delete.png' border='0' alt='".$lang_new[$nuke_module_name]['DELETE']."' title='".$lang_new[$nuke_module_name]['DELETE']."' /></a>";
            }
