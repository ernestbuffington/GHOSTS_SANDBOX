...
$index = 0;
include (TITANIUM_MODULES_DIR.$nuke_module_name.'/includes/Array-Months.php');
include (TITANIUM_MODULES_DIR.$nuke_module_name.'/includes/func-isNumber.php');
include (TITANIUM_MODULES_DIR.$nuke_module_name.'/includes/func-makeSeperator.php'); 
include (TITANIUM_MODULES_DIR.$nuke_module_name.'/includes/func-padMe.php');
include (TITANIUM_MODULES_DIR.$nuke_module_name.'/includes/objLoan.php');  
...
<?
   ...
   echo "</table></div>";
   // CLOSE TABLE FOR NUKE_USER INPUT
...
/***************************************************************************************************************************************************************/ 
   case 3: 
   //include (TITANIUM_MODULES_DIR.$nuke_module_name.'/includes/LoanNdxScroll.php');
   include("header.php"); 
