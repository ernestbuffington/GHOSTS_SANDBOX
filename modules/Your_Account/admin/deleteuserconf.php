...
if(is_mod_admin($nuke_module_name)) {
    ...
    list($email) = $nuke_db->sql_fetchrow($nuke_db->sql_query("SELECT user_email FROM ".$nuke_user_prefix."_users WHERE user_id='$del_uid'"));
    ...
    $nuke_db->sql_query("UPDATE ".$nuke_user_prefix."_users SET name='"._MEMDEL."', username='"._NAMEDEL."', user_password='', user_website='', user_sig='', user_level='-1', user_active='0', user_allow_pm='0', points='0' WHERE user_id='$del_uid'");
