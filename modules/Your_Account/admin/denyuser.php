...
if(is_mod_admin($module_name)) {
    ...
    list($uname) = $nuke_db->sql_fetchrow($nuke_db->sql_query("SELECT username FROM ".$nuke_user_prefix."_users_temp WHERE user_id='$chng_uid'"));
    ...
    echo "<tr><td align=center>"._SURE2DENY." <strong>$uname<i>($chng_uid)</i></strong>?</td></tr>\n";
