 ...
 ******************************************************/
    global $nuke_cache;
    $nuke_cache->delete('ya_config', 'config');
/*****['END']******************************************
 [ Base:    Caching System                     v3.0.0 ]
 ******************************************************/

//    echo "<META HTTP-EQUIV=\"refresh\" content=\"2;URL=modules.php?name=$nuke_module_name&famp;ile=admin&amp;op=UsersConfig\">";
    ...
    echo "<table align=\"center\"><tr><td><form><input type=\"button\" value=\""._USERSCONFIG."\" onclick=\"javascript:location='modules.php?name=".$nuke_module_name."&amp;file=admin&amp;op=UsersConfig';\"></form></td></tr></table>";
    CloseTable();
