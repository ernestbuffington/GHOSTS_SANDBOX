...
if(is_mod_admin($nuke_module_name)) {
    ...
    echo "<form action='modules.php?name=$nuke_module_name&amp;file=admin&amp;op=delFieldConf' method='post'>\n";
    ...
    echo "</form>\n";
    echo "<form action='modules.php?name=$nuke_module_name&amp;file=admin&amp;op=addField' method='post'>\n";
