...
//    echo "<META HTTP-EQUIV=\"refresh\" content=\"2;URL=modules.php?name=$nuke_module_name&amp;file=admin&amp;op=UsersConfig\">";
    ...
    echo "<table align=\"center\"><tr><td><form><input type=\"button\" value=\""._COOKIECONFIG."\" onclick=\"javascript:location='modules.php?name=".$nuke_module_name."&amp;file=admin&amp;op=CookieConfig';\"></form></td></tr></table>";
    CloseTable();
