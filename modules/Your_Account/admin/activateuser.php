...
if (is_mod_admin($nuke_module_name)) {
    ...
    echo "<tr><td colspan=\"2\" align=\"center\">\n";
        ...
        echo "<form action='modules.php?name=$nuke_module_name&amp;file=admin' method='post'><td width=\"49%\" align=\"right\">\n";
        ...
        echo "<td width=\"10\"></td>\n";
        echo "<form action='modules.php?name=$nuke_module_name&amp;file=admin' method='post'><td width=\"49%\" align=\"left\">\n";
        if (isset($min)) { echo "<input type='hidden' name='min' value='$min'>\n"; }
        ...
        echo "</td></tr><tr>\n";
        echo "<form action='modules.php?name=$nuke_module_name&amp;file=admin' method='post'><td colspan=\"3\" align=\"center\">\n";
        if (isset($min)) { echo "<input type='hidden' name='min' value='$min'>\n"; }
        if (isset($xop)) { echo "<input type='hidden' name='xop' value='$xop'>\n"; }
