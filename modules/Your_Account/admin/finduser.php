...
if(is_mod_admin($module_name)) {
    ...
    if (isset($xusername) AND !empty($xusername)) {
        $sql = "SELECT * FROM ".$nuke_user_prefix."_users WHERE username='$xusername'";
    } elseif (isset($xuser_id) AND !empty($xuser_id)) {
        $sql = "SELECT * FROM ".$nuke_user_prefix."_users WHERE user_id='$xuser_id'";
    } elseif (isset($xuser_email) AND !empty($xuser_email)) {
        $sql = "SELECT * FROM ".$nuke_user_prefix."_users WHERE user_email='$xuser_email'";
    }
