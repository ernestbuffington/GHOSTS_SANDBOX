...
if (!defined('CNBYA')) die('CNBYA protection');
  ...
  echo "<img src=\"modules/$nuke_module_name/images/warning.png\" align=\"left\" width=\"40\" height=\"40\"><div align=\"center\">"._YATOSINTRO1."</div></td>\n";
  else 
  echo "<img src=\"modules/$nuke_module_name/images/warning.png\" align=\"left\" width=\"40\" height=\"40\"><div align=\"center\">"._YATOSINTRO2."</div></td>\n";
  CloseTable();
  ...
  if ($setinfo['agreedtos'] == '0'):
    echo "<form name=\"tos1\" action=\"modules.php?name=$nuke_module_name\" method=\"POST\"><td colspan=\"2\">\n";
    ...
    echo "<form name=\"tos1\" action=\"modules.php?name=$nuke_module_name&amp;op=new_user\" method=\"POST\"><td colspan=\"2\">\n";
  endif;
