...
if(!defined('CNBYA'))die('CNBYA protection');
    ...
    if((is_user()) 
	AND (strtolower($nuke_userinfo['username']) == strtolower($cookie[1])) 
	AND ($nuke_userinfo['user_password'] == $cookie[2])): 
	  ...
	  list($value) = $nuke_db->sql_fetchrow( $nuke_db->sql_query("SELECT value FROM ".$nuke_user_prefix."_cnbya_value WHERE fid ='$sqlvalue[fid]' AND uid = '$nuke_userinfo[user_id]'"));
    
      $nuke_userinfo[$sqlvalue['name']] = $value;
      endwhile;

		if(!preg_match("#https://#i", $nuke_userinfo['user_website']) && $nuke_userinfo['user_website'] != "https://"): 
            $nuke_userinfo['user_website'] = "http://".$nuke_userinfo['user_website'];
        endif;
		...
		if($ya_config['allowmailchange'] < 1): 
          ...
          echo "<td bgcolor='$bgcolor3'><input type='text' name='user_email' value=\"$nuke_userinfo[user_email]\" size='50' maxlength='255'><br />"._EMAILNOTPUBLIC."</td></tr>";
		else: 
          echo "<input type='hidden' name='user_email' value=\"$nuke_userinfo[user_email]\">\n";
        endif;
        
		echo "<tr><td bgcolor='$bgcolor2'><strong>"._UFAKEMAIL.":</strong><br />"._OPTIONAL."</td>";
        echo "<td bgcolor='$bgcolor3'><input type='text' name='femail' value=\"$nuke_userinfo[femail]\" size='50' maxlength='255'><br />"._EMAILPUBLIC."</td></tr>";
        echo "<tr><td bgcolor='$bgcolor2'><strong>"._YOURHOMEPAGE.":</strong><br />"._OPTIONAL."</td>";
        echo "<td bgcolor='$bgcolor3'><input type='text' name='user_website' value=\"$nuke_userinfo[user_website]\" size='50' maxlength='255'></td></tr>";
		...
		while($sqlvalue = $nuke_db->sql_fetchrow($result)): 
		  ...
		  if(count($value2) == 1): 
            echo "<tr><td bgcolor='$bgcolor2'><strong>$name_exit</strong></td><td bgcolor='$bgcolor3'><input type='text' name='nfield[$t]' value='".$nuke_userinfo[$sqlvalue[name]]."' size='20' maxlength='$sqlvalue[size]'></td></tr>\n";            
		    ...
		    for ($i = 0; $i<count($value2); $i++): 
			   if(trim($nuke_userinfo[$sqlvalue[name]]) == trim($value2[$i])) 
			   $sel = "selected"; 
			   else 
			   $sel = "";
        ...
        echo "<td bgcolor='$bgcolor3'><input type='text' name='user_icq' value=\"$nuke_userinfo[user_icq]\" size='30' maxlength='100'></td></tr>";
        echo "<tr><td bgcolor='$bgcolor2'><strong>"._YAIM.":</strong><br />"._OPTIONAL."</td>";
        echo "<td bgcolor='$bgcolor3'><input type='text' name='user_aim' value=\"$nuke_userinfo[user_aim]\" size='30' maxlength='100'></td></tr>";
        echo "<tr><td bgcolor='$bgcolor2'><strong>"._YYIM.":</strong><br />"._OPTIONAL."</td>";
        echo "<td bgcolor='$bgcolor3'><input type='text' name='user_yim' value=\"$nuke_userinfo[user_yim]\" size='30' maxlength='100'></td></tr>";
        echo "<tr><td bgcolor='$bgcolor2'><strong>"._YMSNM.":</strong><br />"._OPTIONAL."</td>";
        echo "<td bgcolor='$bgcolor3'><input type='text' name='user_msnm' value=\"$nuke_userinfo[user_msnm]\" size='30' maxlength='100'></td></tr>";
        echo "<tr><td bgcolor='$bgcolor2'><strong>"._YLOCATION.":</strong><br />"._OPTIONAL."</td>";
        echo "<td bgcolor='$bgcolor3'><input type='text' name='user_from' value=\"$nuke_userinfo[user_from]\" size='30' maxlength='100'></td></tr>";
        echo "<tr><td bgcolor='$bgcolor2'><strong>"._YOCCUPATION.":</strong><br />"._OPTIONAL."</td>";
        echo "<td bgcolor='$bgcolor3'><input type='text' name='user_occ' value=\"$nuke_userinfo[user_occ]\" size='30' maxlength='100'></td></tr>";
        echo "<tr><td bgcolor='$bgcolor2'><strong>"._YINTERESTS.":</strong><br />"._OPTIONAL."</td>";
        echo "<td bgcolor='$bgcolor3'><input type='text' name='user_interests' value=\"$nuke_userinfo[user_interests]\" size='30' maxlength='100'></td></tr>";
        echo "<tr><td bgcolor='$bgcolor2'><strong>"._RECEIVENEWSLETTER."</strong></td><td bgcolor='$bgcolor3'>";
        
		if($nuke_userinfo[newsletter] == 1): 
		  $ck1 = " selected"; 
		  $ck2 = ""; 
		else: 
		  $ck1 = ""; 
		...
		if($nuke_userinfo[user_viewemail] == 1): 
		  $ck1 = " selected"; 
		  $ck2 = ""; 
		else: 
		  $ck1 = ""; 
		...
		if($nuke_userinfo[user_allow_viewonline] == 0): 
		  $ck1 = " selected"; 
		  $ck2 = ""; 
		else: 
		  $ck1 = ""; 
		...
		if($nuke_userinfo[user_notify] == 1): 
		  $ck1 = " selected"; 
		  $ck2 = ""; 
		else: 
		  $ck1 = ""; 
		...
		if($nuke_userinfo[user_notify_pm] == 1): 
		  $ck1 = " selected"; 
		  $ck2 = ""; 
		else: 
		  $ck1 = ""; 
		...
		if($nuke_userinfo[user_popup_pm] == 1): 
		  $ck1 = " selected"; 
		  $ck2 = ""; 
		else: 
		  $ck1 = ""; 
		...
		if($nuke_userinfo[user_attachsig] == 1): 
		  $ck1 = " selected"; 
		  $ck2 = ""; 
		else: 
		  $ck1 = ""; 
		...
		if($nuke_userinfo[user_allowbbcode] == 1): 
		  $ck1 = " selected"; 
		  $ck2 = ""; 
		else: 
		  $ck1 = ""; 
		...
		if($nuke_userinfo[user_allowhtml] == 1): 
		  $ck1 = " selected"; 
		  $ck2 = ""; 
		else: 
		  $ck1 = ""; 
		...
		if($nuke_userinfo[user_allowsmile] == 1): 
		   $ck1 = " selected"; 
		   $ck2 = ""; 
		else: 
		   $ck1 = ""; 
		...
		for($i=-12; $i<13; $i++): 
			...
			if($nuke_userinfo[user_timezone] == $i) 
        ...
        echo "<input size='15' maxlength='14' type='text' name='user_dateformat' value=\"$nuke_userinfo[user_dateformat]\">";
        echo "</td></tr>";
        ...
        echo "<td bgcolor='$bgcolor3'><textarea wrap='virtual' cols='50' rows='5' name='bio'>$nuke_userinfo[bio]</textarea><br />"._CANKNOWABOUT."</td></tr>";
        ...
        if($nuke_userinfo[user_avatar_type] == 1) 
            $nuke_user_avatar = $board_config[avatar_path]."/".$nuke_userinfo[user_avatar]; 
		elseif($nuke_userinfo[user_avatar_type] == 2) 
            $nuke_user_avatar = $nuke_userinfo[user_avatar]; 
		else 
            $nuke_user_avatar = $board_config[avatar_gallery_path]."/".$nuke_userinfo[user_avatar]; 
		...
		if(preg_match("#http#", $nuke_userinfo['user_avatar'])) 
            # avatarfix by menelaos dot hetnet dot nl 
            echo "<td bgcolor='$bgcolor3' align=center>"._YA_CURRAV."<br /><IMG alt=\"\" src=\"$direktori/$nuke_userinfo[user_avatar]\" width=\"40\" height=\"50\"></td></tr>";
		elseif($nuke_userinfo[user_avatar]) 
            echo "<td bgcolor='$bgcolor3' align=center>"._YA_CURRAV."<br /><IMG alt=\"\" src=\"$direktori/$nuke_userinfo[user_avatar]\" width=\"40\" height=\"50\"></td></tr>";
        ...
        if($board_config['allow_avatar_remote']): 
			...
			if ($nuke_userinfo[user_avatar_type] == 2) 
            echo "<td bgcolor='$bgcolor3'><input class=post style=\"WIDTH: 150px\" size='25' name='avatar' value=\"".$nuke_userinfo[user_avatar]."\"> &nbsp;&nbsp;<input class=mainoption type=submit value=Submit></td></tr>";
            else 
