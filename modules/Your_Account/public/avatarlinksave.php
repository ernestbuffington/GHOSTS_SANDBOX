...
if(!defined('CNBYA')) die('CNBYA protection');
    ...
    $nuke_db->sql_query("UPDATE ".$nuke_user_prefix."_users SET user_avatar='$avatar', user_avatar_type='2' WHERE username='$cookie[1]'");
	...
	if (preg_match("/(https)/", $avatar)): 
      ...
      echo "[ <a href=\"modules.php?name=$nuke_module_name&amp;op=edituser\">"._YA_BACKPROFILE."</a> | <a href=\"modules.php?name=$nuke_module_name\">"._YA_DONE."</a> ]</div>";
	elseif($avatar): 
