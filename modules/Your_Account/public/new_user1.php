...
// menelaos: by request: added realname to the registration form
    echo "<tr><td bgcolor='$bgcolor2'><div class=\"textbold\">"._UREALNAME.":</div>"._OPTIONAL."</td><td bgcolor='$bgcolor1'><input type='text' name='ya_realname' size='40' maxlength='60'><br /><span class='tiny'>"._YA_REALNAMENOTE."</span></td></tr>\n";
 ...
 ******************************************************/
    ...
    if(!empty($gfx)) {
        echo "<tr><td bgcolor='$bgcolor2' colspan='2' style='text-align:center;'>".$gfx."</td></tr>";
    }
	# start Nuke Honeypot
