...
if (isset($_POST['coppa_yes']) AND $ya_config['coppa'] == intval(1)) {
    ...
    if($coppa != intval(1)){
        ...
        title(_USERAPPLOGIN);
        OpenTable();
        echo "<img src=\"modules/$nuke_module_name/images/warning.png\" align=\"left\" width=\"40\" height=\"40\" alt=\"\"><center>"._YACOPPA2."</center></td>\n";
        CloseTable();
        echo "<br />";
        OpenTable();
...
OpenTable();
  OpenTable();
  echo "<form name=\"coppa1\" action=\"modules.php?name=$nuke_module_name&amp;op=new_user\" method=\"POST\">\n";
