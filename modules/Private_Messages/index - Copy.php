...
if ( isset($HTTP_POST_VARS[NUKE_POST_POST_URL]) || isset($HTTP_GET_VARS[NUKE_POST_POST_URL]) )
{
    $privmsg_id = ( isset($HTTP_POST_VARS[NUKE_POST_POST_URL]) ) ? intval($HTTP_POST_VARS[NUKE_POST_POST_URL]) : intval($HTTP_GET_VARS[NUKE_POST_POST_URL]);
}
else
{
    $privmsg_id = '';
...
else if ( $mode == 'read' )
{
        ...
        {
                $privmsgs_id = intval($HTTP_GET_VARS[NUKE_POST_POST_URL]);
        }
        else
        {
 ...
 ******************************************************/
                                ...
                                {
                                    message_die(NUKE_GENERAL_ERROR, 'Failed sending email :: ' . $emailer_result, '', __LINE__, __FILE__);
                                }
/*****[END]********************************************
 [ Mod:     Custom mass PM                     v1.4.7 ]
 ******************************************************/
