...
function ns_doc_questions() {
    global $questions, $nuke_module_name, $sitename;
...
{
    global $aboutus, $disclaimer, $privacy, $terms, $nuke_module_name;
    echo "<div align=\"center\">";
    if ($aboutus == 1) echo "[ <a href=\"modules.php?name=$nuke_module_name&amp;file=about\">"._NSABOUTUS."</a> ]";
    if ($aboutus == 1 && $disclaimer == 1) echo " - ";
    if ($disclaimer == 1) echo "[ <a href=\"modules.php?name=$nuke_module_name&amp;file=disclaimer\">"._NSDISCLAIMER."</a> ]";
    if ($disclaimer == 1 && $privacy == 1) echo " - ";
    if ($privacy == 1) echo "[ <a href=\"modules.php?name=$nuke_module_name&amp;file=privacy\">"._NSPRIVACY."</a> ]";
    if (($privacy == 1 || $aboutus == 1 || $disclaimer ==1) AND ($terms == 1)) echo " - ";
    if ($terms == 1) echo "[ <a href=\"modules.php?name=$nuke_module_name&amp;file=terms\">"._NSTERMS."</a> ]";
    echo "</div><br /><br />";
}
