...
function terms() 
{
    global $sitename, $nuke_module_name, $adminmail;
    ...
    if (file_exists(NUKE_MODULES_DIR.$nuke_module_name.'/copyright.php')) 
	{
		...
		echo '<div align="center"><h1>The 86it Developers Network Terms Of Use</h1></div>';
        ...
        echo ""._NSTERMSUSE1a." ";
        echo "<a href=\"modules.php?name=$nuke_module_name&amp;file=privacy\" target=\"_blank\">";
