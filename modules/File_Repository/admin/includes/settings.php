...
function _file_repository_configuration()
{
	...
	echo '  <tr'._bgColor(2).'>'."\n";
	echo '    <td'._tdcss(false,'center',_sh(),2).'>'._suh($lang_new[$nuke_module_name]['ADMINISTRATION_MODULE']).'</td>'."\n";
	echo '  </tr>'."\n";
	echo '  <tr'._bgColor(1).'>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._sut($lang_new[$nuke_module_name]['VERSION']).'</td>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'.$settings['version'].'</td>'."\n";
	echo '  </tr>'."\n";
	echo '  <tr'._bgColor(2).'>'."\n";
	echo '	  <td'._tdcss(false,false,_sh(),2).'>'._suh($lang_new[$nuke_module_name]['GENERAL']).'</td>'."\n";
	echo '  </tr>'."\n";
	# added in 1.1.0
	echo '  <tr'._bgColor(1).'>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._sut($lang_new[$nuke_module_name]['LEGEND_SHOW']).'</td>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._yesno('show_legend',$settings['show_legend']).'</td>'."\n";
	echo '  </tr>'."\n";
	# added in 1.1.0
	echo '  <tr'._bgColor(1).'>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._sut($lang_new[$nuke_module_name]['MOST_HITS']).'</td>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._input_numbers('pophits',1,5000,1,$settings['pophits']).'</td>'."\n";
	echo '  </tr>'."\n";
	echo '  <tr'._bgColor(1).'>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._sut($lang_new[$nuke_module_name]['LIGHTBOX']).'</td>'."\n";
	$colorbox = ((file_exists('includes/jquery/jquery.colorbox.js') || file_exists('includes/js/colorbox/jquery.colorbox-min.js') || file_exists('includes/js/jquery.colorbox.php')) ? array('colorbox' => $lang_new[$nuke_module_name]['CB']) : array());
	$fancybox = ((file_exists('includes/jquery/jquery.fancybox.js') || file_exists('includes/fancybox/jquery.fancybox.js') || file_exists('includes/js/jquery.fancybox.js') || file_exists('includes/js/jquery.fancybox.php')) ? array('fancybox' => $lang_new[$nuke_module_name]['FB']) : array());
	$lightbox = ((file_exists('includes/jquery/jquery.lightbox.js')
		...
		|| file_exists('includes/js/jquery.lightbox.php')) ? array('lightbox' => $lang_new[$nuke_module_name]['LB']) : array());
	$lightboxevo = (file_exists('includes/js/jquery.lightbox.evolution.php')) ? array('lightboxevo' => $lang_new[$nuke_module_name]['LE']) : array();
	...
	echo '  </tr>'."\n";
	echo '  <tr'._bgColor(1).'>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._sut($lang_new[$nuke_module_name]['DEVELOPER']).'</td>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._yesno('developer_mode',$settings['developer_mode']).'</td>'."\n";
	echo '  </tr>'."\n";
	echo '  <tr'._bgColor(1).'>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._sut($lang_new[$nuke_module_name]['MOST_POPULAR']).'</td>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._input_numbers('most_popular',1,50,1,$settings['most_popular']).'</td>'."\n";
	echo '  </tr>'."\n";
	echo '  <tr'._bgColor(2).'>'."\n";
	echo '	  <td'._tdcss(false,false,_sh(),2).'>'._suh($lang_new[$nuke_module_name]['OVERVIEW']).'</td>'."\n";
	echo '  </tr>'."\n";	
	echo '  <tr'._bgColor(1).'>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._sut($lang_new[$nuke_module_name]['OVERVIEW_DISPLAY']).'</td>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._selectbox('overview_display',array(0 => $lang_new[$nuke_module_name]['N'], 1 => $lang_new[$nuke_module_name]['Y']),$settings['overview_display']).'</td>'."\n";
	echo '  </tr>'."\n";
	echo '  <tr'._bgColor(1).'>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._sut($lang_new[$nuke_module_name]['OVERVIEW_COUNT']).'</td>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._input_numbers('overview_count',1,10,1,$settings['overview_count']).'</td>'."\n";
	echo '  </tr>'."\n";
	# added in 1.1.0
	$whereToDisplay = array(
		'newdownloads' => $lang_new[$nuke_module_name]['NEW_DOWNLOADS'],
		'mostpopular' => $lang_new[$nuke_module_name]['MOST_POPULAR_OPTION'],
		'statistics' => $lang_new[$nuke_module_name]['STATISTICS'],
		'search' => $lang_new[$nuke_module_name]['SEARCH'],
		'submitdownload' => $lang_new[$nuke_module_name]['USER_UPLOAD_OPTION']
	);
	echo '  <tr'._bgColor(1).'>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._sut($lang_new[$nuke_module_name]['OVERVIEW_DISPLAY_WHERE']).'</td>'."\n";
	...
	# added in 1.1.0
	echo '  <tr'._bgColor(2).'>'."\n";
	echo '	  <td'._tdcss(false,false,_sh(),2).'>'._suh($lang_new[$nuke_module_name]['SECURITY']).'</td>'."\n";
	echo '  </tr>'."\n";
	echo '  <tr'._bgColor(1).'>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._sut($lang_new[$nuke_module_name]['GFXCHECKING']).'</td>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._selectbox('usegfxcheck',array(0 => $lang_new[$nuke_module_name]['N'], 1 => $lang_new[$nuke_module_name]['Y']),$settings['usegfxcheck']).'</td>'."\n";
	echo '  </tr>'."\n";
	echo '  <tr'._bgColor(1).'>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._sut($lang_new[$nuke_module_name]['ADMIN_BYPASS']).'</td>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._selectbox('adminBypass',array(0 => $lang_new[$nuke_module_name]['N'], 1 => $lang_new[$nuke_module_name]['Y']),$settings['adminBypass']).'</td>'."\n";
	echo '  </tr>'."\n";
	# added in 1.1.0
	echo '  <tr'._bgColor(2).'>'."\n";
	echo '	  <td'._tdcss(false,false,_sh(),2).'>'._suh($lang_new[$nuke_module_name]['EXTENSION_MANAGEMENT']).'</td>'."\n";
	echo '  </tr>'."\n";
	echo '  <tr'._bgColor(1).'>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._sut($lang_new[$nuke_module_name]['EXTENSION_FILES']).'</td>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._input('text','allowed_file_extensions','150px',$settings['allowed_file_extensions']).'</td>'."\n";
	echo '  </tr>'."\n";
	echo '  <tr'._bgColor(1).'>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._sut($lang_new[$nuke_module_name]['EXTENSION_IMAGES']).'</td>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._input('text','allowed_image_extensions','150px',$settings['allowed_image_extensions']).'</td>'."\n";
	echo '  </tr>'."\n";
	echo '  <tr'._bgColor(2).'>'."\n";
	echo '	  <td'._tdcss(false,false,_sh(),2).'>'._suh($lang_new[$nuke_module_name]['USER_UPLOAD']).'</td>'."\n";
	echo '  </tr>'."\n";
	echo '  <tr'._bgColor(1).'>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._sut($lang_new[$nuke_module_name]['USER_UPLOAD_ALLOWED']).'</td>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._selectbox('users_can_upload',array(0 => $lang_new[$nuke_module_name]['N'], 1 => $lang_new[$nuke_module_name]['Y']),$settings['users_can_upload']).'</td>'."\n";
	echo '  </tr>'."\n";
	echo '  <tr'._bgColor(1).'>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._sut($lang_new[$nuke_module_name]['GROUPS_ALLOWED_TO_UPLOAD']).'</td>'."\n";
	...
	echo '  </tr>'."\n";
	echo '  <tr'._bgColor(1).'>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._sut($lang_new[$nuke_module_name]['USER_UPLOAD_FILE_AMOUNT']).'</td>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._input_numbers('users_file_upload_amount',1,5,1,$settings['users_file_upload_amount']).'</td>'."\n";
	echo '  </tr>'."\n";
	echo '  <tr'._bgColor(1).'>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._sut($lang_new[$nuke_module_name]['USER_UPLOAD_IMAGE_AMOUNT']).'</td>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._input_numbers('users_screens_upload_amount',1,5,1,$settings['users_screens_upload_amount']).'</td>'."\n";
	echo '  </tr>'."\n";
	# added in 1.1.0 
	echo '  <tr'._bgColor(2).'>'."\n";
	echo '	  <td'._tdcss(false,false,_sh(),2).'>'._suh($lang_new[$nuke_module_name]['COSMETIC']).'</td>'."\n";
	echo '  </tr>'."\n";
	echo '  <tr'._bgColor(1).'>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._sut($lang_new[$nuke_module_name]['UHEAD']).'</td>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._selectbox('uhead',array(0 => $lang_new[$nuke_module_name]['N'], 1 => $lang_new[$nuke_module_name]['Y']),$settings['uhead']).'</td>'."\n";
	echo '  </tr>'."\n";
	echo '  <tr'._bgColor(1).'>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._sut($lang_new[$nuke_module_name]['UTEXT']).'</td>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._selectbox('utext',array(0 => $lang_new[$nuke_module_name]['N'], 1 => $lang_new[$nuke_module_name]['Y']),$settings['utext']).'</td>'."\n";
	echo '  </tr>'."\n";
	echo '  <tr'._bgColor(1).'>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._sut($lang_new[$nuke_module_name]['DOWNLOAD_LAYOUT']).'</td>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._selectbox('download_view',array(0 => $lang_new[$nuke_module_name]['DOWNLOAD_LAYOUT_SINGLE'], 1 => $lang_new[$nuke_module_name]['DOWNLOAD_LAYOUT_SIDEBYSIDE']),$settings['download_view']).'</td>'."\n";
	echo '  </tr>'."\n";
	echo '  <tr'._bgColor(1).'>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._sut($lang_new[$nuke_module_name]['PARSE_SMILIES']).'</td>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._selectbox('parse_smilies',array(0 => $lang_new[$nuke_module_name]['N'], 1 => $lang_new[$nuke_module_name]['Y']),$settings['parse_smilies']).'</td>'."\n";
	echo '  </tr>'."\n";
	echo '  <tr'._bgColor(1).'>'."\n";
	echo '    <td'._tdcss('50%',false,_sc()).'>'._sut($lang_new[$nuke_module_name]['DATE_FORMAT']).'</td>'."\n";
...
//---------------------------------------------------------------------
	...
	{
		echo '  <tr'._bgColor(2).'>'."\n";
		echo '	  <td'._tdcss(false,false,_sh(),2).'>'._suh($lang_new[$nuke_module_name]['PAYMENTS']).'</td>'."\n";
		echo '  </tr>'."\n";
		echo '  <tr'._bgColor(1).'>'."\n";
		echo '    <td'._tdcss('50%',false,_sc()).'>'._sut($lang_new[$nuke_module_name]['CURRENCY_DEFAULT']).'</td>'."\n";
		echo '    <td'._tdcss('50%',false,_sc()).'>'._selectbox('currency',array('CAD' => $lang_new[$nuke_module_name]['CAD'], 'EUR' => $lang_new[$nuke_module_name]['EUR'], 'GBP' => $lang_new[$nuke_module_name]['GBP'], 'USD' => $lang_new[$nuke_module_name]['USD']),$settings['currency']).'</td>'."\n";
		echo '  </tr>'."\n";
	}
//---------------------------------------------------------------------
//	PAYPAL SETTINGS
...
//---------------------------------------------------------------------
	...
	echo '  <tr'._bgColor(2).'>'."\n";
	echo '    <td'._tdcss(false,false,_sh(),2).'>'._suh($lang_new[$nuke_module_name]['THEMES']).'</td>'."\n";
	echo '  </tr>'."\n";
	echo '  <tr'._bgColor(1).'>'."\n";
	...
	echo '	      <tr'._bgColor(2).'>'."\n";
	echo '          <td'._tdcss($alternateWidth,false,_sh(),$colspan).'>'._suh($lang_new[$nuke_module_name]['THEME_NAME']).'</td>'."\n";
//---------------------------------------------------------------------
//	HIDE THIS OPTION IN EVOLUTION NUKE, AS IT CANT BE USED
//---------------------------------------------------------------------
	if(!defined('NUKE_EVO'))
		echo '          <td'._tdcss($alternateWidth,false,_sh()).'>'._suh($lang_new[$nuke_module_name]['THEME_BLOCKS_SHOW']).'</td>'."\n";
//---------------------------------------------------------------------
	echo '          <td'._tdcss($alternateWidth,false,_sh($settings['download_view'])).'>'._suh($lang_new[$nuke_module_name]['THEME_FILES']).'</td>'."\n";
	echo '          <td'._tdcss($alternateWidth,false,_sh()).'>'._suh($lang_new[$nuke_module_name]['THEME_CELL']).'</td>'."\n";
	echo '          <td'._tdcss($alternateWidth,false,_sh()).'>'._suh($lang_new[$nuke_module_name]['THEME_HEADER']).'</td>'."\n";
	echo '        </tr>'."\n";
...
//---------------------------------------------------------------------
			if(!defined('NUKE_EVO')) 
				echo '    <td'._tdcss($alternateWidth,false,_sc()).'>'._selectbox('show_left'.$i,array('1' => $lang_new[$nuke_module_name]['SHOWN'], '0' => $lang_new[$nuke_module_name]['HIDDEN']),$row['show_left']).'</td>'."\n";
//---------------------------------------------------------------------
...
//---------------------------------------------------------------------	
	echo '  <tr'._bgColor(2).'>'."\n";
	echo '    <td'._tdcss(false,'center',_sf(),2).'>'._submit($lang_new[$nuke_module_name]['SETTINGS_SAVE']).'</td>'."\n";
	echo '  </tr>'."\n";
	echo '</table>'."\n";
