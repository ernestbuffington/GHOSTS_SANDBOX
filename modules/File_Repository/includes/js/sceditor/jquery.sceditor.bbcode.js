...
;(function ($, window, document) {
	...
	var _templates = {
		...
		youtube:	'<iframe width="560" height="315" src="http://www.youtube.com/embed/{id}?rel=0&vq=hd1080" data-youtube-id="{id}" frameborder="0" allowfullscreen></iframe>'
	};
...
// TODO: Make configurable
	...
	$.sceditor.defaultOptions = {
		...
		emoticons: {
			dropdown: {
				':)': 'modules/' + module_name + '/images/emoticons/smile.png',
				':angel:': 'modules/' + module_name + '/images/emoticons/angel.png',
				':angry:': 'modules/' + module_name + '/images/emoticons/angry.png',
				'8-)': 'modules/' + module_name + '/images/emoticons/cool.png',
				":'(": 'modules/' + module_name + '/images/emoticons/cwy.png',
				':ermm:': 'modules/' + module_name + '/images/emoticons/ermm.png',
				':D': 'modules/' + module_name + '/images/emoticons/grin.png',
				'<3': 'modules/' + module_name + '/images/emoticons/heart.png',
				':(': 'modules/' + module_name + '/images/emoticons/sad.png',
				':O': 'modules/' + module_name + '/images/emoticons/shocked.png',
				':P': 'modules/' + module_name + '/images/emoticons/tongue.png',
				';)': 'modules/' + module_name + '/images/emoticons/wink.png'
			},
			more: {
				':alien:': 'modules/' + module_name + '/images/emoticons/alien.png',
				':blink:': 'modules/' + module_name + '/images/emoticons/blink.png',
				':blush:': 'modules/' + module_name + '/images/emoticons/blush.png',
				':cheerful:': 'modules/' + module_name + '/images/emoticons/cheerful.png',
				':devil:': 'modules/' + module_name + '/images/emoticons/devil.png',
				':dizzy:': 'modules/' + module_name + '/images/emoticons/dizzy.png',
				':getlost:': 'modules/' + module_name + '/images/emoticons/getlost.png',
				':happy:': 'modules/' + module_name + '/images/emoticons/happy.png',
				':kissing:': 'modules/' + module_name + '/images/emoticons/kissing.png',
				':ninja:': 'modules/' + module_name + '/images/emoticons/ninja.png',
				':pinch:': 'modules/' + module_name + '/images/emoticons/pinch.png',
				':pouty:': 'modules/' + module_name + '/images/emoticons/pouty.png',
				':sick:': 'modules/' + module_name + '/images/emoticons/sick.png',
				':sideways:': 'modules/' + module_name + '/images/emoticons/sideways.png',
				':silly:': 'modules/' + module_name + '/images/emoticons/silly.png',
				':sleeping:': 'modules/' + module_name + '/images/emoticons/sleeping.png',
				':unsure:': 'modules/' + module_name + '/images/emoticons/unsure.png',
				':woot:': 'modules/' + module_name + '/images/emoticons/w00t.png',
				':wassat:': 'modules/' + module_name + '/images/emoticons/wassat.png',
				':whistling:': 'modules/' + module_name + '/images/emoticons/whistling.png',
				':love:': 'modules/' + module_name + '/images/emoticons/wub.png'
			},
			hidden: {
				':whistling:': 'modules/' + module_name + '/images/emoticons/whistling.png',
				':love:': 'modules/' + module_name + '/images/emoticons/wub.png'
