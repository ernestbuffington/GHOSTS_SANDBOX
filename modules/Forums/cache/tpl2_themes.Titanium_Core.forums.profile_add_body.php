...
// eXtreme Styles mod cache. Generated on Thu, 08 Sep 2022 12:02:22 +0000 (time=1662638542)
  ...
  <tr>
    ...
    <td class="row2" style="width: 50%;">
      <select name="birthday_display">
        <option value="<?php echo isset($this->vars['NUKE_BIRTHDAY_ALL']) ? $this->vars['NUKE_BIRTHDAY_ALL'] : $this->lang('NUKE_BIRTHDAY_ALL'); ?>"<?php echo isset($this->vars['BIRTHDAY_ALL_SELECTED']) ? $this->vars['BIRTHDAY_ALL_SELECTED'] : $this->lang('BIRTHDAY_ALL_SELECTED'); ?>><?php echo isset($this->vars['L_BIRTHDAY_ALL']) ? $this->vars['L_BIRTHDAY_ALL'] : $this->lang('L_BIRTHDAY_ALL'); ?></option>
        <option value="<?php echo isset($this->vars['NUKE_BIRTHDAY_DATE']) ? $this->vars['NUKE_BIRTHDAY_DATE'] : $this->lang('NUKE_BIRTHDAY_DATE'); ?>"<?php echo isset($this->vars['BIRTHDAY_DATE_SELECTED']) ? $this->vars['BIRTHDAY_DATE_SELECTED'] : $this->lang('BIRTHDAY_DATE_SELECTED'); ?>><?php echo isset($this->vars['L_BIRTHDAY_YEAR']) ? $this->vars['L_BIRTHDAY_YEAR'] : $this->lang('L_BIRTHDAY_YEAR'); ?></option>
        <option value="<?php echo isset($this->vars['NUKE_BIRTHDAY_AGE']) ? $this->vars['NUKE_BIRTHDAY_AGE'] : $this->lang('NUKE_BIRTHDAY_AGE'); ?>"<?php echo isset($this->vars['BIRTHDAY_AGE_SELECTED']) ? $this->vars['BIRTHDAY_AGE_SELECTED'] : $this->lang('BIRTHDAY_AGE_SELECTED'); ?>><?php echo isset($this->vars['L_BIRTHDAY_AGE']) ? $this->vars['L_BIRTHDAY_AGE'] : $this->lang('L_BIRTHDAY_AGE'); ?></option>
        <option value="<?php echo isset($this->vars['NUKE_BIRTHDAY_NONE']) ? $this->vars['NUKE_BIRTHDAY_NONE'] : $this->lang('NUKE_BIRTHDAY_NONE'); ?>"<?php echo isset($this->vars['BIRTHDAY_NONE_SELECTED']) ? $this->vars['BIRTHDAY_NONE_SELECTED'] : $this->lang('BIRTHDAY_NONE_SELECTED'); ?>><?php echo isset($this->vars['L_BIRTHDAY_NONE']) ? $this->vars['L_BIRTHDAY_NONE'] : $this->lang('L_BIRTHDAY_NONE'); ?></option>
      </select>
    </td>
  </tr>
  <?php
