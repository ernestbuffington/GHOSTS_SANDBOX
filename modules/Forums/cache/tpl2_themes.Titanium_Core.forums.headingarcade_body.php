...
// eXtreme Styles mod cache. Generated on Fri, 09 Sep 2022 11:18:30 +0000 (time=1662722310)
 ...
 <table width="100%" cellpadding="2" cellspacing="3" border="0">
    ...
    <tr>
        <td width="100%">
          ...
          <tr>
            <td class="cat" width="25%"><p align="center"><span class="cattitle"><?php echo isset($this->vars['L_TOP']) ? $this->vars['L_TOP'] : $this->lang('L_TOP'); ?></span></p></td>
            <td class="cat" width="60%"><p align="center"><span class="cattitle"><?php echo isset($this->vars['L_RECENT']) ? $this->vars['L_RECENT'] : $this->lang('L_RECENT'); ?></span></p></td>
            <td class="cat" width="15%"><p align="center"><span class="cattitle"><?php echo isset($this->vars['L_USER_INFO']) ? $this->vars['L_USER_INFO'] : $this->lang('L_USER_INFO'); ?></span></p></td>
          </tr>
...
?>
                            <tr>
                              <td class="<?php echo isset($bestscore2_item['CLASS']) ? $bestscore2_item['CLASS'] : ''; ?>"  align=left width="85%" valign="top"><p>&nbsp;<span class=smallfont>• </span><span class="gensmall"><?php echo isset($bestscore2_item['L_HEADING_CHAMP']) ? $bestscore2_item['L_HEADING_CHAMP'] : ''; ?></span></p></td>
...
?> 
        ...
        <td class="row1" align="center" valign="center" width="15%" rowspan="2" height="93"><p align="center">
                        ...
                        <span class="gensmall"><img src="modules/Forums/templates/subSilver/images/couronne.gif"><?php echo isset($this->vars['ARCADE_VICTOIRES']) ? $this->vars['ARCADE_VICTOIRES'] : $this->lang('ARCADE_VICTOIRES'); ?></span><br />
...
?>
                    <tr>
                      <td class=alt1 vAlign=top align=left width="85%"><p><span class="gensmall"><span class=smallfont>• </span><span class="gensmall"><?php echo isset($score3_item['L_LAST_SCORE']) ? $score3_item['L_LAST_SCORE'] : ''; ?></span></p></td>
                    </tr>
                           <?php
