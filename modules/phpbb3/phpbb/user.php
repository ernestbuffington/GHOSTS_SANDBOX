	...
	*/
	function setup($lang_set = false, $style_id = false)
	{
		...
		*/
		...
		{
			if (strpos($this->page['query_string'], 'mode=reg_details') === false && $this->page['page_name'] != "modules.php?name=phpBB3&amp;file=ucp")
			{
				redirect(append_sid("modules.php?name=phpBB3&amp;file=ucp", 'i=profile&amp;mode=reg_details'));
			}
		}
