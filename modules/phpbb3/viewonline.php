...
$phpbb_root_path = (defined('NUKE_PHPBB3_DIR')) ? NUKE_PHPBB3_DIR : './';  #### ADD Ernest Allen Buffington 09/09/2022 [ ONLY IDIOTS JUMP ON BAND WAGONS ]
...
while ($row = $db->sql_fetchrow($result))
{
	...
	switch ($on_page[1])
	{
		case 'index':
			...
			$location_url = append_sid("modules.php?name=$nuke_module_name");
		break;
