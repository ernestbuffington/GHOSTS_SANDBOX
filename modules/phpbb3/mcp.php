...
include(NUKE_PHPBB3_DIR . 'includes/functions_admin.' . $phpEx);
include(NUKE_PHPBB3_DIR . 'includes/functions_mcp.' . $phpEx);
require(NUKE_PHPBB3_DIR . 'includes/functions_module.' . $phpEx);
else:
