...
{
	$delmarksquery = "delete from ".$prefix."_bookmarks where category_id=$catid AND user_id=$nuke_userid";
	$delcatquery   = "delete from ".$prefix."_bookmarks_cat where category_id=$catid AND user_id=$nuke_userid";
