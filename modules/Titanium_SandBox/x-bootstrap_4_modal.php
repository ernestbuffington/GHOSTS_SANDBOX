...
$nuke_page_header .= '<div align="center"><h1>If you are logged in via FTP the current file location is: /public_html/modules/'.$module_name.'/'.$current_file_name.'.php<h1></div>';
