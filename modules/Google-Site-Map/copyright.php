...
$nuke_module_version = 'v1.0b';
$release_date = 'April 11th, 2021';
$nuke_module_description = 'Google Site Map';
$mod_cost = '$300.00 US Dollars';

function show_copyright() 
{
    global $mod_cost, $forum, $mod_name, $nuke_module_name, $release_date, $nuke_author_name, $nuke_author_email, $nuke_author_homepage, $license, $download_location, $nuke_module_version, $nuke_module_description;

    if ($mod_name == "") { $mod_name = str_replace("-", " ", $nuke_module_name); }
	...
	if ($nuke_module_version != "") { print '&#8226;&nbsp;<strong>Module Version:</strong> '.$nuke_module_version.'<br />'; }
	...
	if ($nuke_module_description != "") { print '&#8226;&nbsp;<strong>Module Description:</strong> '.$nuke_module_description.'<br />'; }
