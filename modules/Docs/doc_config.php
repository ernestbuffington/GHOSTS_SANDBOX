...
function ns_doc_links() {
    ...
    if ($aboutus == 1) {
         ...
         $aboutus_html_string = '[ <a href=modules.php?name='.$nuke_module_name.'&amp;file=about>'._NSABOUTUS.'</a> ] - ';
    ...
    if ($disclaimer == 1) {
         echo "[ <a href=\"modules.php?name=$nuke_module_name&amp;file=disclaimer\">"._NSDISCLAIMER."</a> ]";
    }
    if ($disclaimer == 1 && $privacy == 1) {
         echo " - ";
    }
    if ($privacy == 1) {
         echo "[ <a href=\"modules.php?name=$nuke_module_name&amp;file=privacy\">"._NSPRIVACY."</a> ]";
    }
    if (($privacy == 1 || $aboutus == 1 || $disclaimer ==1) AND ($terms == 1)) {
         echo " - ";
    }
    if ($terms == 1) {
         echo "[ <a href=\"modules.php?name=$nuke_module_name&amp;file=terms\">"._NSTERMS."</a> ]";
    }
         echo "</div>";
         echo "<br /><br />";
}
