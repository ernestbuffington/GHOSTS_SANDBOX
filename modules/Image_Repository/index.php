...
//-------------------------------------------------------------------------
if(file_exists(NUKE_MODULES_DIR.$nuke_module_name.'/language/lang-'.$nuke_userinfo['user_lang'].'.php'))
	include_once(NUKE_MODULES_DIR.$nuke_module_name.'/language/lang-'.$nuke_userinfo['user_lang'].'.php');
else
