...
if($project['allowrequests'] > 0) {
  ...
  echo "<td><input type='text' name='commenter_name' size='30' value='".$nuke_userinfo['username']."'></td></tr>\n";
  echo "<tr><td bgcolor='$bgcolor2'>"._NETWORK_EMAILADDRESS.":</td>\n";
  echo "<td><input type='text' name='commenter_email' size='30' value='".$nuke_userinfo['user_email']."'></td></tr>\n";
