...
if($project['allowreports'] > 0) {
  ...
  $pjimage = pjimage("reporter.png", $nuke_module_name);
  echo "<tr><td align='center'><img src='$pjimage'></td>\n";
  ...
  echo "<tr><td bgcolor='$bgcolor2' width='100%'><nobr><strong>"._NETWORK_COMMENTS."</strong> <strong>(</strong> <a href='modules.php?name=$nuke_module_name&amp;op=ReportCommentSubmit&amp;report_id=$report_id'>"._NETWORK_COMMENTADD."</a> <strong>)</strong></nobr></td><tr>\n";
  if($comment_total > 0){
