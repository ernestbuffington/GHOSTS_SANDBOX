...
$pagetitle = "::: "._NETWORK_TITLE." ".$pj_config['version_number']."::: "._NETWORK_TASKS.": "._NETWORK_DELETEPRIORITY;
...
pjadmin_menu(_NETWORK_TASKS.": "._NETWORK_DELETEPRIORITY);
//echo "<br />\n";
OpenTable();
echo "<table align='center' border='0' cellpadding='2' cellspacing='2'>\n";
echo "<form method='post' action='".$admin_file.".php'>\n";
echo "<input type='hidden' name='op' value='TaskPriorityDelete'>\n";
echo "<input type='hidden' name='priority_id' value='$priority_id'>\n";
echo "<tr><td align='center'><strong>"._NETWORK_SWAPTASKPRIORITY."</strong></td></tr>\n";
echo "<tr><td align='center'>".$priority['priority_name']." -> <select name='swap_priority_id'>\n";
echo "<option value='-1'>"._NETWORK_NA."</option>\n";
$prioritylist = $network_db->sql_query("SELECT `priority_id`, `priority_name` FROM `".$network_prefix."_tasks_priorities` WHERE `priority_id` != '$priority_id' AND `priority_id` > 0 ORDER BY `priority_weight`");
