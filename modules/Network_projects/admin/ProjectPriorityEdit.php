...
$pagetitle = "::: "._NETWORK_TITLE." ".$pj_config['version_number']."::: "._NETWORK_PROJECTS.": "._NETWORK_EDITPRIORITY;
...
pjadmin_menu(_NETWORK_PROJECTS.": "._NETWORK_EDITPRIORITY);
//echo "<br />\n";
OpenTable();
echo "<table align='center' border='0' cellpadding='2' cellspacing='2'>\n";
echo "<form method='post' action='".$admin_file.".php'>\n";
echo "<input type='hidden' name='op' value='ProjectPriorityUpdate'>\n";
...
echo "<tr><td colspan='2' align='center'><input type='submit' value='"._NETWORK_UPDATEPROJECTPRIORITY."'></td></tr>\n";
echo "</form>\n";
echo "</table>\n";
CloseTable();
pj_copy();
