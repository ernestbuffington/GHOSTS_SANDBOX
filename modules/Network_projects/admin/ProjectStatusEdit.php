...
$pagetitle = "::: "._NETWORK_TITLE." ".$pj_config['version_number']."::: "._NETWORK_PROJECTS.": "._NETWORK_EDITSTATUS;
...
echo "<input type='hidden' name='op' value='ProjectStatusUpdate'>\n";
...
echo "<tr><td colspan='2' align='center'><input type='submit' value='"._NETWORK_UPDATEPROJECTSTATUS."'></td></tr>\n";
echo "</form>\n";
echo "</table>\n";
CloseTable();
pj_copy();
