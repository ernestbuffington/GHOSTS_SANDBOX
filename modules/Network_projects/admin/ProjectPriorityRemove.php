...
$prioritylist = $network_db->sql_query("SELECT `priority_id`, `priority_name` FROM `".$network_prefix."_projects_priorities` WHERE `priority_id` != '$priority_id' AND `priority_id` > 0 ORDER BY `priority_weight`");
