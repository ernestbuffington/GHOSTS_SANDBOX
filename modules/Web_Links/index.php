...
require_once(NUKE_MODULES_DIR.$nuke_module_name.'/l_config.php');
...
{
    global $prefix, $nuke_db, $nuke_module_name;
    ...
    $pparentid = intval($row['parentid']);
	if (!empty($ptitle)) 
	$title="<a href=modules.php?name=$nuke_module_name&amp;l_op=viewlink&amp;cid=$cid>$ptitle</a>/".$title;
	if ($pparentid!=0) 
...
function menu($mainlink) 
{
    ...
    echo "<div align=\"center\"><a href=\"modules.php?name=".$nuke_module_name."\"><img style=\"max-height: 50px;\" src=\"themes/".$ThemeSel."/images/Web_links/Web_Links.png\" border=\"0\" alt=\"\"></a><br /><br />";
     
	else: 
	
    echo "<div align=\"center\"><a href=\"modules.php?name=".$nuke_module_name."\"><img style=\"max-height: 50px;\" src=\"modules/".$nuke_module_name."/images/Web_Links.png\" border=\"0\" alt=\"\"></a><br /><br />";
    endif;
    
	echo "<form action=\"modules.php?name=".$nuke_module_name."&amp;l_op=search&amp;query=".$query."\" method=\"post\">"
	...
	if ($mainlink>0): 
    echo "<a href=\"modules.php?name=".$nuke_module_name."\"><i class=\"bi bi-link\"></i> "._LINKSMAIN."</a>  ";
    endif;
    
	echo " <a href=\"modules.php?name=".$nuke_module_name."&amp;l_op=AddLink\"><i class=\"bi bi-link\"></i> "._ADDLINK."</a>"
        ." <a href=\"modules.php?name=".$nuke_module_name."&amp;l_op=NewLinks\"><i class=\"bi bi-link\"></i> "._NEW."</a>"
        ." <a href=\"modules.php?name=".$nuke_module_name."&amp;l_op=MostPopular\"><i class=\"bi bi-link\"></i> "._POPULAR."</a>"
        ." <a href=\"modules.php?name=".$nuke_module_name,"&amp;l_op=TopRated\"><i class=\"bi bi-link\"></i> "._TOPRATED."</a>"
       #."<a href=\"modules.php?name=$nuke_module_name&amp;l_op=RandomLink\"><i class=\"bi bi-link\"></i> "._RANDOM."</a> " <- This is garbage
        ."</strong>"
	    ."</span></div>";
...
{
    global $nuke_module_name, $nuke_user;
    
	echo "<span class=\"content\"><strong>"
    ."<i class=\"bi bi-person-square\"></i>&nbsp;<a href=\"modules.php?name=".$nuke_module_name."&amp;l_op=viewlinkcomments&amp;lid=".$lid."&amp;ttitle=".$ttitle."\">"._LINKCOMMENTS."</a>&nbsp;&nbsp;"
    ."<i class=\"bi bi-info-square\"></i>&nbsp;<a href=\"modules.php?name=".$nuke_module_name."&amp;l_op=viewlinkdetails&amp;lid=".$lid."&amp;ttitle=".$ttitle."\">"._ADDITIONALDET."</a>&nbsp;&nbsp;"
    ."<i class=\"bi bi-clipboard-data\"></i>&nbsp;<a href=\"modules.php?name=".$nuke_module_name."&amp;l_op=viewlinkeditorial&amp;lid=".$lid."&amp;ttitle=".$ttitle."\">"._EDITORREVIEW."</a>&nbsp;&nbsp;"
    ."<i class=\"bi bi-pencil-square\"></i>&nbsp;<a href=\"modules.php?name=".$nuke_module_name."&amp;l_op=modifylinkrequest&amp;lid=".$lid."\">"._MODIFY."</a>&nbsp;&nbsp;";
    
	if (is_user()):
    echo "<i class=\"bi bi-backspace-reverse\"></i>&nbsp;<a href=\"modules.php?name=".$nuke_module_name."&amp;l_op=brokenlink&amp;lid=".$lid."\">"._REPORTBROKEN."</a>&nbsp;&nbsp;";
    endif;
    echo " </span></strong>";
}
...
function AddLink() 
{
    global $prefix, $nuke_db, $nuke_user, $links_anonaddlinklock, $nuke_module_name;
    include_once(NUKE_BASE_DIR.'header.php');
    $mainlink = 1;
    menu(1);
    ...
    if (is_user() || $links_anonaddlinklock == 1):
        ...
        ."<strong><big><i class=\"bi bi-person-bounding-box\"></i></big></strong> "._USERANDIP."<br /><br />"
            ...
            ."<form method=\"post\" action=\"modules.php?name=$nuke_module_name&amp;l_op=Add\">"
 ...
 ******************************************************/
    ...
    include_once(NUKE_BASE_DIR.'header.php');
	OpenTable();
	$error_message[] = $lang_new[$nuke_module_name]['reCaptcha'];
	CloseTable();
    include_once(NUKE_BASE_DIR.'footer.php');
	endif;
/*****[END]********************************************
...
function NewLinks($newlinkshowdays) 
{
    ...
    .""._SHOW.": <a href=\"modules.php?name=$nuke_module_name&amp;l_op=NewLinks&amp;newlinkshowdays=7\">"._1WEEK."</a> - <a href=\"modules.php?name=$nuke_module_name&amp;l_op=NewLinks&amp;newlinkshowdays=14\">"._2WEEKS."</a> - <a href=\"modules.php?name=$nuke_module_name&amp;l_op=NewLinks&amp;newlinkshowdays=30\">"._30DAYS."</a>"
    ."</div><br />";
...
{
    global $prefix, $nuke_db, $nuke_module_name, $admin, $nuke_user, $admin_file, $locale, $mainvotedecimal, $datetime;
    ...
    while ($row2 = $nuke_db->sql_fetchrow($result2)):
      ...
      echo "<font size=\"4\"><i class=\"bi bi-link\"></i></font> <a href=\"modules.php?name=$nuke_module_name&amp;l_op=visit&amp;lid=$lid\" target=\"new\">$title</a>";
      ...
      echo "<i class=\"bi bi-calendar4\"></i> Added <strong>$datetime</strong> "._HITS.": $hits";
       $transfertitle = str_replace (" ", "_", $title);
        ...
        echo "<a href=\"modules.php?name=$nuke_module_name&amp;l_op=ratelink&amp;lid=$lid&amp;ttitle=$transfertitle\">"._RATESITE."</a>";
        if (is_user()) 
        echo " | <a href=\"modules.php?name=$nuke_module_name&amp;l_op=brokenlink&amp;lid=$lid\">"._REPORTBROKEN."</a>";
        if ($totalvotes != 0) 
        echo " | <a href=\"modules.php?name=$nuke_module_name&amp;l_op=viewlinkdetails&amp;lid=$lid&amp;ttitle=$transfertitle\">"._DETAILS."</a>";
        if ($totalcomments != 0) 
        echo " | <a href=\"modules.php?name=$nuke_module_name&amp;l_op=viewlinkcomments&amp;lid=$lid&amp;ttitle=$transfertitle\">"._SCOMMENTS." ($totalcomments)</a>";
...
{
    global $prefix, $nuke_db, $admin, $nuke_module_name, $nuke_user, $locale, $mainvotedecimal, $datetime;
    
	include_once(NUKE_BASE_DIR.'header.php');
    include(NUKE_MODULES_DIR.$nuke_module_name.'/l_config.php');
	menu(1);
    OpenTable();
    ...
    .""._SHOWTOP.":  [ <a href=\"modules.php?name=$nuke_module_name&amp;l_op=TopRated&amp;ratenum=10&amp;ratetype=num\">10</a> - "
    ."<a href=\"modules.php?name=$nuke_module_name&amp;l_op=TopRated&amp;ratenum=25&amp;ratetype=num\">25</a> - "
        ."<a href=\"modules.php?name=$nuke_module_name&amp;l_op=TopRated&amp;ratenum=50&amp;ratetype=num\">50</a> | "
        ."<a href=\"modules.php?name=$nuke_module_name&amp;l_op=TopRated&amp;ratenum=1&amp;ratetype=percent\">1%</a> - "
        ."<a href=\"modules.php?name=$nuke_module_name&amp;l_op=TopRated&amp;ratenum=5&amp;ratetype=percent\">5%</a> - "
        ."<a href=\"modules.php?name=$nuke_module_name&amp;l_op=TopRated&amp;ratenum=10&amp;ratetype=percent\">10%</a> ]</div><br /><br /></td></tr>";
	...
	while($row = $nuke_db->sql_fetchrow($result)): 
      ...
      $linkratingsummary = number_format($linkratingsummary, $mainvotedecimal);
      echo "<a href=\"modules.php?name=$nuke_module_name&amp;l_op=visit&amp;lid=$lid\" target=\"new\">$title</a>";
      newlinkgraphic($datetime, $time);
      popgraphic($hits);
      echo "<br />";
      ...
      echo "<br /><a href=\"modules.php?name=$nuke_module_name&amp;l_op=ratelink&amp;lid=$lid&amp;ttitle=$transfertitle\">"._RATESITE."</a>";
...
{
    global $prefix, $nuke_db, $admin, $nuke_module_name, $nuke_user, $admin_file, $locale, $mainvotedecimal, $datetime;
    include_once(NUKE_BASE_DIR.'header.php');
    include(NUKE_MODULES_DIR.$nuke_module_name.'/l_config.php');
    menu(1);
	...
	echo "<tr><td><center>"._SHOWTOP.": [ <a href=\"modules.php?name=$nuke_module_name&amp;l_op=MostPopular&amp;ratenum=10&amp;ratetype=num\">10</a> - "
    ."<a href=\"modules.php?name=$nuke_module_name&amp;l_op=MostPopular&amp;ratenum=25&amp;ratetype=num\">25</a> - "
        ."<a href=\"modules.php?name=$nuke_module_name&amp;l_op=MostPopular&amp;ratenum=50&amp;ratetype=num\">50</a> | "
        ."<a href=\"modules.php?name=$nuke_module_name&amp;l_op=MostPopular&amp;ratenum=1&amp;ratetype=percent\">1%</a> - "
        ."<a href=\"modules.php?name=$nuke_module_name&amp;l_op=MostPopular&amp;ratenum=5&amp;ratetype=percent\">5%</a> - "
        ."<a href=\"modules.php?name=$nuke_module_name&amp;l_op=MostPopular&amp;ratenum=10&amp;ratetype=percent\">10%</a> ]</center><br /><br /></td></tr>";
    ...
    $linkratingsummary = number_format($linkratingsummary, $mainvotedecimal);
    echo "<span class=\"content\"><font size=\"4\"><i class=\"bi bi-link-45deg\"></i></font> <a href=\"modules.php?name=$nuke_module_name&amp;l_op=visit&amp;lid=$lid\" target=\"new\">$title</a>";
    newlinkgraphic($datetime, $time);
    popgraphic($hits);
    echo "<br />";
...
{
    global $prefix, $nuke_db, $admin, $perpage, $nuke_module_name, $nuke_user, $admin_file, $locale, $mainvotedecimal, $datetime;
    $show = intval($show);
	...
	$title="<a href=modules.php?name=$nuke_module_name>"._MAIN."</a>/$title";
	...
	while($row3 = $nuke_db->sql_fetchrow($result3)):
        ...
        if ($space>0) 
        echo ",&nbsp;";
        echo "<span class=\"content\"><a href=\"modules.php?name=$nuke_module_name&amp;l_op=viewlink&amp;cid=$cid3\">$title3</a></span>";
        $space++;
    endwhile;
	...
	echo "<center><span class=\"content\">"._SORTLINKSBY.": "
        .""._TITLE." (<a href=\"modules.php?name=$nuke_module_name&amp;l_op=viewlink&amp;cid=$cid&amp;orderby=titleA\">A</a>\<a href=\"modules.php?name=$nuke_module_name&amp;l_op=viewlink&amp;cid=$cid&amp;orderby=titleD\">D</a>) "
        .""._DATE." (<a href=\"modules.php?name=$nuke_module_name&amp;l_op=viewlink&amp;cid=$cid&amp;orderby=dateA\">A</a>\<a href=\"modules.php?name=$nuke_module_name&amp;l_op=viewlink&amp;cid=$cid&amp;orderby=dateD\">D</a>) "
        .""._RATING." (<a href=\"modules.php?name=$nuke_module_name&amp;l_op=viewlink&amp;cid=$cid&amp;orderby=ratingA\">A</a>\<a href=\"modules.php?name=$nuke_module_name&amp;l_op=viewlink&amp;cid=$cid&amp;orderby=ratingD\">D</a>) "
        .""._POPULARITY." (<a href=\"modules.php?name=$nuke_module_name&amp;l_op=viewlink&amp;cid=$cid&amp;orderby=hitsA\">A</a>\<a href=\"modules.php?name=$nuke_module_name&amp;l_op=viewlink&amp;cid=$cid&amp;orderby=hitsD\">D</a>)"
    ...
    $linkratingsummary = number_format($linkratingsummary, $mainvotedecimal);
        echo "<font size=\"4\"><i class=\"bi bi-link\"></i></font> <a href=\"modules.php?name=$nuke_module_name&amp;l_op=visit&amp;lid=$lid\" target=\"new\"><strong>$title</strong></a>";
    newlinkgraphic($datetime, $time);
    popgraphic($hits);
    ...
    if ($linkpages!=1 && $linkpages!=0):
        ...
        $prev=$min-$perpage;
	     ...
	     if ($prev>=0): 
            echo "&nbsp;&nbsp;<strong>[ <a href=\"modules.php?name=$nuke_module_name&amp;l_op=viewlink&amp;cid=$cid&amp;min=$prev&amp;orderby=$orderby&amp;show=$show\">";
     ...
     $currentpage = ($max / $perpage);
           ...
           while ($counter<=$linkpages ):
              ...
              echo "<a href=\"modules.php?name=$nuke_module_name&amp;l_op=viewlink&amp;cid=$cid&amp;min=$mintemp&amp;orderby=$orderby&amp;show=$show\">$counter</a> ";
              $counter++;
           endwhile;
		 ...
		 if ($x>=$perpage):
            echo "&nbsp;&nbsp;<strong>[ <a href=\"modules.php?name=$nuke_module_name&amp;l_op=viewlink&amp;cid=$cid&amp;min=$max&amp;orderby=$orderby&amp;show=$show\">";
            echo " "._NEXT." &gt;&gt;</a> ]</strong> ";
         endif;
...
{
    global $nuke_module_name, $locale;
    ...
    $daysold = date("d-M-Y", $startdate);
        if ("$daysold" == "$datetime"): 
            if ($count<=1) 
              echo "<img src=\"modules/$nuke_module_name/images/new_01.png\" alt=\""._NEWTODAY."\">";
            if ($count<=3 && $count>1) 
               echo "<img src=\"modules/$nuke_module_name/images/new_03.png\" alt=\""._NEWLAST3DAYS."\">";
            if ($count<=7 && $count>3) 
              echo "<img src=\"modules/$nuke_module_name/images/new_07.png\" alt=\""._NEWTHISWEEK."\">";
       endif;
        $count++;
...
{
    global $prefix, $nuke_db, $nuke_module_name, $locale;
    $cat = intval(trim($cat));
    ...
    $daysold = date("d-M-Y", $startdate);
        if ("$daysold" == "$datetime"):
        if ($count<=1) 
        echo "<img src=\"modules/$nuke_module_name/images/new_01.png\" alt=\""._CATNEWTODAY."\">";
        if ($count<=3 && $count>1) 
        echo "<img src=\"modules/$nuke_module_name/images/new_03.png\" alt=\""._CATLAST3DAYS."\">";
        if ($count<=7 && $count>3) 
        echo "<img src=\"modules/$nuke_module_name/images/new_07.png\" alt=\""._CATTHISWEEK."\">";
    endif;
        $count++;
        $startdate = (time()-(86400 * $count));
    endwhile;
...
function popgraphic($hits) 
{
    ...
    include(NUKE_MODULES_DIR.$nuke_module_name.'/l_config.php');
    if ($hits>=$popular) 
    echo "&nbsp;<img src=\"modules/$nuke_module_name/images/pop.gif\" alt=\""._POPULAR."\">";
}
...
{
    global $prefix, $nuke_db, $admin, $bgcolor2, $nuke_module_name, $locale, $mainvotedecimal, $datetime;
    include(NUKE_MODULES_DIR.$nuke_module_name.'/l_config.php');
    include_once(NUKE_BASE_DIR.'header.php');
	...
	if ($query != "") :
		...
		echo "<span class=\"option\">"._SEARCHRESULTS4.": <strong>$the_query</strong></span><br /><br />"
            ...
            echo "<strong><big>&middot;</big></strong>&nbsp;<a href=\"modules.php?name=$nuke_module_name&amp;l_op=viewlink&amp;cid=$cid\">$title3</a> ($numrows)<br />";
        endwhile;
        ...
        echo "<br /><span class=\"content\">"._SORTLINKSBY.": "
            .""._TITLE." (<a href=\"modules.php?name=$nuke_module_name&amp;l_op=search&amp;query=$the_query&amp;orderby=titleA\">A</a>\<a href=\"modules.php?name=$nuke_module_name&amp;l_op=search&amp;query=$the_query&amp;orderby=titleD\">D</a>)"
            .""._DATE." (<a href=\"modules.php?name=$nuke_module_name&amp;l_op=search&amp;query=$the_query&amp;orderby=dateA\">A</a>\<a href=\"modules.php?name=$nuke_module_name&amp;l_op=search&amp;query=$the_query&amp;orderby=dateD\">D</a>)"
            .""._RATING." (<a href=\"modules.php?name=$nuke_module_name&amp;l_op=search&amp;query=$the_query&amp;orderby=ratingA\">A</a>\<a href=\"modules.php?name=$nuke_module_name&amp;l_op=search&amp;query=$the_query&amp;orderby=ratingD\">D</a>)"
            .""._POPULARITY." (<a href=\"modules.php?name=$nuke_module_name&amp;l_op=search&amp;query=$the_query&amp;orderby=hitsA\">A</a>\<a href=\"modules.php?name=$nuke_module_name&amp;l_op=search&amp;query=$the_query&amp;orderby=hitsD\">D</a>)"
    ...
    if ($prev>=0)
            echo "&nbsp;&nbsp;<strong>[ <a href=\"modules.php?name=$nuke_module_name&amp;l_op=search&amp;query=$the_query&amp;min=$prev&amp;orderby=$orderby&amp;show=$show\">"
            ." &lt;&lt; "._PREVIOUS."</a> ]</strong> ";
    ...
    $counter = 1;
		...
		while ($counter<=$linkpages ):
         ...
         echo "<a href=\"modules.php?name=$nuke_module_name&amp;l_op=search&amp;query=$the_query&amp;min=$mintemp&amp;orderby=$orderby&amp;show=$show\">$counter</a> ";
         $counter++;
        endwhile;
        ...
        if ($x>=$perpage) 
            echo "&nbsp;&nbsp;<strong>[ <a href=\"modules.php?name=$nuke_module_name&amp;l_op=search&amp;query=$the_query&amp;min=$max&amp;orderby=$orderby&amp;show=$show\">"
            ." "._NEXT." &gt;&gt;</a> ]</strong>";
    endif;
...
{
    global $prefix, $nuke_db, $admin, $nuke_module_name;
...
function detecteditorial($lid, $ttitle) 
{
	...
	if ($recordexist != 0) 
    echo " | <a href=\"modules.php?name=$nuke_module_name&amp;l_op=viewlinkeditorial&amp;lid=$lid&amp;ttitle=$ttitle\">"._EDITORIAL."</a>";
    
}

function viewlinkcomments($lid, $ttitle) 
{
    global $prefix, $nuke_db, $admin, $bgcolor2, $nuke_module_name, $admin_file;
    include_once(NUKE_BASE_DIR.'header.php');
    include(NUKE_MODULES_DIR.$nuke_module_name.'/l_config.php');
    menu(1);
    $lid = intval(trim($lid));
	...
	while($row2 = $nuke_db->sql_fetchrow($result2))
	    ...
	    if (is_mod_admin($nuke_module_name)) 
        echo "<a href=\"".$admin_file.".php?op=LinksModLink&amp;lid=$lid\"><img src=\"modules/$nuke_module_name/images/editicon.gif\" border=\"0\" alt=\""._EDITTHISLINK."\"></a>";
...
{
    global $prefix, $nuke_db, $admin, $bgcolor1, $bgcolor2, $bgcolor3, $bgcolor4, $nuke_module_name, $anonymous;
...
function linkfooter($lid,$ttitle) 
{
    ...
    echo "<span class=\"content\"> <i class=\"bi bi-globe2\"></i> <a href=\"modules.php?name=$nuke_module_name&amp;l_op=visit&amp;lid=$lid\" target=\"_blank\">"._VISITTHISSITE."</a>&nbsp;&nbsp;<i class=\"bi bi-check-square\"></i> <a href=\"modules.php?name=$nuke_module_name&amp;l_op=ratelink&amp;lid=$lid&amp;ttitle=$ttitle\">"._RATETHISSITE."</a> </span><br /><br />";
...
function linkfooterchild($lid) 
{
    ...
    include(NUKE_MODULES_DIR.$nuke_module_name.'/l_config.php');
    if ($useoutsidevoting = 1) 
    echo "<br /><span class=\"content\">"._ISTHISYOURSITE." <a href=\"modules.php?name=$nuke_module_name&amp;l_op=outsidelinksetup&amp;lid=$lid\">"._ALLOWTORATE."</a></span>";
}

function outsidelinksetup($lid) 
{
    global $nuke_module_name, $sitename, $nukeurl;
    include_once(NUKE_BASE_DIR.'header.php');
    include(NUKE_MODULES_DIR.$nuke_module_name.'/l_config.php');
    menu(1);
	...
	echo '<div align="center"><a href="'.$nukeurl.'/modules.php?name='.$nuke_module_name.'&amp;l_op=ratelink&amp;lid='.$lid.'">'._RATETHISSITE.' @ '.$sitename.'</a></div><br />';


    echo '<div align="center">'._HTMLCODE1.'</div><br />';

    echo '<div align="center"><textarea rows="4" cols="50"><a href="'.$nukeurl.'/modules.php?name='.$nuke_module_name.'&amp;l_op=ratelink&amp;lid='.$lid.'">'._RATETHISSITE.' @ '.$sitename.'</a></textarea></div><br /><hr>';
    ...
    echo '<div align="center">';
    echo '<form method="post" action="'.$nukeurl.'/modules.php?name='.$nuke_module_name.'">';
...
{
    global $prefix, $nuke_db, $nuke_user, $cookie, $nuke_module_name;
...
function brokenlinkS($lid,$cid, $title, $url, $description, $modifysubmitter) 
{
    ...
    global $prefix, $nuke_db, $nuke_user, $anonymous, $cookie, $nuke_module_name, $nuke_user, $nuke_cache;
...
{
    global $prefix, $nuke_db, $nuke_user, $nuke_module_name, $anonymous, $cookie;
    include_once(NUKE_BASE_DIR.'header.php');
    include(NUKE_MODULES_DIR.$nuke_module_name.'/l_config.php');
...
{
    global $prefix, $nuke_db, $nuke_user, $nuke_module_name, $cookie, $nuke_cache;
    include(NUKE_MODULES_DIR.$nuke_module_name.'/l_config.php');
...
{
    global $prefix, $nuke_db, $cookie, $nuke_user, $nuke_module_name, $anonymous;
    $passtest = "yes";
    include_once(NUKE_BASE_DIR.'header.php');
    include(NUKE_MODULES_DIR.$nuke_module_name.'/l_config.php');
    ...
    if (!empty($ratingcomments)):
	    ...
	    if ($rating > 10 || $rating < 1):
          nuke_redirect("modules.php?name=$nuke_module_name&d_op=ratedownload&lid=$ratinglid");
          exit;
        endif;
...
{
    global $prefix, $nuke_db, $sitename, $nuke_module_name;
...
{
    global $prefix, $cookie, $datetime, $nuke_module_name, $identify;
    include_once(NUKE_BASE_DIR.'header.php');
    menu(1);
    ...
    echo "</ul>"
        ."<br /><form method=\"post\" action=\"modules.php?name=$nuke_module_name\">"
