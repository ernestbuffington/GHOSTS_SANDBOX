...
$topics = 1;
automated_news();
if ($topic == 0 OR empty($topic)) { nuke_redirect("modules.php?name=$nuke_module_name"); }
...
switch ($op) {
    ...
    case "newindex":
        ...
        while ($artinfo = $nuke_db->sql_fetchrow($result)) {
			...
			//if (is_user()) {
            //    $the_icons .= " | <a href='modules.php?name=$nuke_module_name&amp;file=print&amp;sid=".$artinfo["sid"]."'><img src='images/print.gif' border='0' alt='"._PRINTER."' title='"._PRINTER."' width='11' height='11'></a>&nbsp;<a href='modules.php?name=$nuke_module_name&amp;file=friend&amp;op=FriendSend&amp;sid=".$artinfo["sid"]."'><img src='images/friend.gif' border='0' alt='"._FRIEND."' title='"._FRIEND."' width='11' height='11'></a>\n";
            //}
        ...
        if ($articlepages!=1 && $articlepages!=0) {
            ...
            while ($counter <= $articlepages ) {
                ...
                if ($counter == $currentpage) {
                    ...
                    echo "<option value='modules.php?name=$nuke_module_name&amp;min=$mintemp&amp;file=topics&amp;topic=$topic'>$counter</option>\n";
                }
                $counter++;
            }
