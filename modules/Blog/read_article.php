...
nuke_redirect("modules.php?name=$nuke_module_name&file=read_article&sid=$sid");
else
...
if ($op == "Reply") 
nuke_redirect("modules.php?name=$nuke_module_name&file=comments&op=Reply&pid=0&sid=$sid&mode=$mode&order=$order&thold=$thold");
