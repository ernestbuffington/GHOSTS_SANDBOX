...
if ($op == "Reply") 
{
	...
	nuke_redirect("modules.php?name=$nuke_module_name&file=comments&op=Reply&pid=0&sid=".$sid.$display);
}
...
if ($catid != 0) {
    ...
    $title = "<a href=\"modules.php?name=$nuke_module_name&amp;file=categories&amp;op=newindex&amp;catid=$catid\"><font class=\"storycat\">$title1</font></a>: $title";
}
...
include_once("modules/$nuke_module_name/associates.php");

if (((empty($mode) OR ($mode != "nocomments")) OR ($acomm == 0)) OR ($articlecomm == 1)) 
@include_once("modules/$nuke_module_name/comments.php");
...
$boxstuff .= "<hr noshade width=\"95%\" size=\"1\">Blog Subject<br /><a href=\"modules.php?name=$nuke_module_name&amp;file=article&amp;sid=$topstory\">$ttitle</a></span></div><br />\n";
...
$ratecontent .= "<form action=\"modules.php?name=$nuke_module_name\" method=\"post\"><center>"._RATETHISARTICLE."</div><br />";
...
else
{
  ...
  $ratecontent .= "<form action=\"modules.php?name=$nuke_module_name\" method=\"post\"><img src=\"modules/Blog/images/blockspacer.png\" alt=\"\" width=\"10\" height=\"10\" ><br /><div align=center>"._RATETHISARTICLE."</div><br />";
