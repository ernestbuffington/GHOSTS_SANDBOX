		...
		foreach ($permission_victim as $victim)
		{
			switch ($victim)
			{
				...
				case 'user':
					...
					$template->assign_vars(array(
						'S_SELECT_USER'			=> true,
						'U_FIND_USERNAME'		=> append_sid("{$phpbb3_root_path}memberlist.$phpEx", 'mode=searchuser&amp;form=select_victim&amp;field=username&amp;select_single=true'),
					));
				...
				case 'usergroup_view':
					...
					$template->assign_vars(array(
						...
						'U_FIND_USERNAME'			=> append_sid("{$phpbb3_root_path}memberlist.$phpEx", 'mode=searchuser&amp;form=add_user&amp;field=username&amp;select_single=true'),
					));
