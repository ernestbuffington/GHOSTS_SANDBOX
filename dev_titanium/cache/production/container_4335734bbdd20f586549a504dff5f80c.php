...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    {
        return $this->services['config'] = new \phpbb\config\db(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, 'nuke_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'nuke_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility(${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, './', 'php', 'nuke_forums', 'nuke_posts', 'nuke_topics', 'nuke_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('nuke_captcha_questions', 'nuke_captcha_answers', 'nuke_qa_confirm');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'}, 'nuke_ext', './', 'php', ${($_ = isset($this->services['cache']) ? $this->services['cache'] : $this->getCacheService()) && false ?: '_'});
    }
    ...
    {
        return new \phpbb\notification\method\email(${($_ = isset($this->services['user_loader']) ? $this->services['user_loader'] : $this->getUserLoaderService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './', 'php', 'nuke_notification_emails');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, './', 'php', 'nuke_user_notifications');
    ...
    {
        return $this->services['path_helper'] = new \phpbb\path_helper(${($_ = isset($this->services['symfony_request']) ? $this->services['symfony_request'] : $this->getSymfonyRequestService()) && false ?: '_'}, ${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, './', 'php', 'admin/adm/');
    }
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'nuke_profile_fields_lang');
    }
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'nuke_bbcodes', 'nuke_smilies', 'nuke_styles', 'nuke_words', './styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'nuke_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'nuke_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'nuke_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'nuke_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_option'] = $instance = new \phpbb\textreparser\plugins\poll_option(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'nuke_poll_options');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'nuke_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'nuke_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'nuke_users');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './', 'php', 'nuke_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'tables.acl_groups' => 'nuke_acl_groups',
            'tables.acl_options' => 'nuke_acl_options',
            'tables.acl_roles' => 'nuke_acl_roles',
            'tables.acl_roles_data' => 'nuke_acl_roles_data',
            'tables.acl_users' => 'nuke_acl_users',
            'tables.attachments' => 'nuke_attachments',
            'tables.auth_provider_oauth_token_storage' => 'nuke_oauth_tokens',
            'tables.auth_provider_oauth_states' => 'nuke_oauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'nuke_oauth_accounts',
            'tables.banlist' => 'nuke_banlist',
            'tables.bbcodes' => 'nuke_bbcodes',
            'tables.bookmarks' => 'nuke_bookmarks',
            'tables.bots' => 'nuke_bots',
            'tables.captcha_qa_questions' => 'nuke_captcha_questions',
            'tables.captcha_qa_answers' => 'nuke_captcha_answers',
            'tables.captcha_qa_confirm' => 'nuke_qa_confirm',
            'tables.config' => 'nuke_config',
            'tables.config_text' => 'nuke_config_text',
            'tables.confirm' => 'nuke_confirm',
            'tables.disallow' => 'nuke_disallow',
            'tables.drafts' => 'nuke_drafts',
            'tables.ext' => 'nuke_ext',
            'tables.extensions' => 'nuke_extensions',
            'tables.extension_groups' => 'nuke_extension_groups',
            'tables.forums' => 'nuke_forums',
            'tables.forums_access' => 'nuke_forums_access',
            'tables.forums_track' => 'nuke_forums_track',
            'tables.forums_watch' => 'nuke_forums_watch',
            'tables.groups' => 'nuke_groups',
            'tables.icons' => 'nuke_icons',
            'tables.lang' => 'nuke_lang',
            'tables.log' => 'nuke_log',
            'tables.login_attempts' => 'nuke_login_attempts',
            'tables.migrations' => 'nuke_migrations',
            'tables.moderator_cache' => 'nuke_moderator_cache',
            'tables.modules' => 'nuke_modules',
            'tables.notification_emails' => 'nuke_notification_emails',
            'tables.notification_types' => 'nuke_notification_types',
            'tables.notifications' => 'nuke_notifications',
            'tables.poll_options' => 'nuke_poll_options',
            'tables.poll_votes' => 'nuke_poll_votes',
            'tables.posts' => 'nuke_posts',
            'tables.privmsgs' => 'nuke_privmsgs',
            'tables.privmsgs_folder' => 'nuke_privmsgs_folder',
            'tables.privmsgs_rules' => 'nuke_privmsgs_rules',
            'tables.privmsgs_to' => 'nuke_privmsgs_to',
            'tables.profile_fields' => 'nuke_profile_fields',
            'tables.profile_fields_data' => 'nuke_profile_fields_data',
            'tables.profile_fields_options_language' => 'nuke_profile_fields_lang',
            'tables.profile_fields_language' => 'nuke_profile_lang',
            'tables.ranks' => 'nuke_ranks',
            'tables.reports' => 'nuke_reports',
            'tables.reports_reasons' => 'nuke_reports_reasons',
            'tables.search_results' => 'nuke_search_results',
            'tables.search_wordlist' => 'nuke_search_wordlist',
            'tables.search_wordmatch' => 'nuke_search_wordmatch',
            'tables.sessions' => 'nuke_sessions',
            'tables.sessions_keys' => 'nuke_sessions_keys',
            'tables.sitelist' => 'nuke_sitelist',
            'tables.smilies' => 'nuke_smilies',
            'tables.sphinx' => 'nuke_sphinx',
            'tables.styles' => 'nuke_styles',
            'tables.styles_template' => 'nuke_styles_template',
            'tables.styles_template_data' => 'nuke_styles_template_data',
            'tables.styles_theme' => 'nuke_styles_theme',
            'tables.styles_imageset' => 'nuke_styles_imageset',
            'tables.styles_imageset_data' => 'nuke_styles_imageset_data',
            'tables.teampage' => 'nuke_teampage',
            'tables.topics' => 'nuke_topics',
            'tables.topics_posted' => 'nuke_topics_posted',
            'tables.topics_track' => 'nuke_topics_track',
            'tables.topics_watch' => 'nuke_topics_watch',
            'tables.user_group' => 'nuke_user_group',
            'tables.user_notifications' => 'nuke_user_notifications',
            'tables.users' => 'nuke_users',
            'tables.warnings' => 'nuke_warnings',
            'tables.words' => 'nuke_words',
            'tables.zebra' => 'nuke_zebra',
            ...
            'tables' => [
                'acl_groups' => 'nuke_acl_groups',
                'acl_options' => 'nuke_acl_options',
                'acl_roles' => 'nuke_acl_roles',
                'acl_roles_data' => 'nuke_acl_roles_data',
                'acl_users' => 'nuke_acl_users',
                'attachments' => 'nuke_attachments',
                'auth_provider_oauth_token_storage' => 'nuke_oauth_tokens',
                'auth_provider_oauth_states' => 'nuke_oauth_states',
                'auth_provider_oauth_account_assoc' => 'nuke_oauth_accounts',
                'banlist' => 'nuke_banlist',
                'bbcodes' => 'nuke_bbcodes',
                'bookmarks' => 'nuke_bookmarks',
                'bots' => 'nuke_bots',
                'captcha_qa_questions' => 'nuke_captcha_questions',
                'captcha_qa_answers' => 'nuke_captcha_answers',
                'captcha_qa_confirm' => 'nuke_qa_confirm',
                'config' => 'nuke_config',
                'config_text' => 'nuke_config_text',
                'confirm' => 'nuke_confirm',
                'disallow' => 'nuke_disallow',
                'drafts' => 'nuke_drafts',
                'ext' => 'nuke_ext',
                'extensions' => 'nuke_extensions',
                'extension_groups' => 'nuke_extension_groups',
                'forums' => 'nuke_forums',
                'forums_access' => 'nuke_forums_access',
                'forums_track' => 'nuke_forums_track',
                'forums_watch' => 'nuke_forums_watch',
                'groups' => 'nuke_groups',
                'icons' => 'nuke_icons',
                'lang' => 'nuke_lang',
                'log' => 'nuke_log',
                'login_attempts' => 'nuke_login_attempts',
                'migrations' => 'nuke_migrations',
                'moderator_cache' => 'nuke_moderator_cache',
                'modules' => 'nuke_modules',
                'notification_emails' => 'nuke_notification_emails',
                'notification_types' => 'nuke_notification_types',
                'notifications' => 'nuke_notifications',
                'poll_options' => 'nuke_poll_options',
                'poll_votes' => 'nuke_poll_votes',
                'posts' => 'nuke_posts',
                'privmsgs' => 'nuke_privmsgs',
                'privmsgs_folder' => 'nuke_privmsgs_folder',
                'privmsgs_rules' => 'nuke_privmsgs_rules',
                'privmsgs_to' => 'nuke_privmsgs_to',
                'profile_fields' => 'nuke_profile_fields',
                'profile_fields_data' => 'nuke_profile_fields_data',
                'profile_fields_options_language' => 'nuke_profile_fields_lang',
                'profile_fields_language' => 'nuke_profile_lang',
                'ranks' => 'nuke_ranks',
                'reports' => 'nuke_reports',
                'reports_reasons' => 'nuke_reports_reasons',
                'search_results' => 'nuke_search_results',
                'search_wordlist' => 'nuke_search_wordlist',
                'search_wordmatch' => 'nuke_search_wordmatch',
                'sessions' => 'nuke_sessions',
                'sessions_keys' => 'nuke_sessions_keys',
                'sitelist' => 'nuke_sitelist',
                'smilies' => 'nuke_smilies',
                'sphinx' => 'nuke_sphinx',
                'styles' => 'nuke_styles',
                'styles_template' => 'nuke_styles_template',
                'styles_template_data' => 'nuke_styles_template_data',
                'styles_theme' => 'nuke_styles_theme',
                'styles_imageset' => 'nuke_styles_imageset',
                'styles_imageset_data' => 'nuke_styles_imageset_data',
                'teampage' => 'nuke_teampage',
                'topics' => 'nuke_topics',
                'topics_posted' => 'nuke_topics_posted',
                'topics_track' => 'nuke_topics_track',
                'topics_watch' => 'nuke_topics_watch',
                'user_group' => 'nuke_user_group',
                'user_notifications' => 'nuke_user_notifications',
                'users' => 'nuke_users',
                'warnings' => 'nuke_warnings',
                'words' => 'nuke_words',
                'zebra' => 'nuke_zebra',
            ],
            'core.adm_relative_path' => 'admin/adm/',
            'core.table_prefix' => 'nuke_',
