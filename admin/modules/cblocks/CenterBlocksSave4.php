...
$result = $nuke_db->sql_query("UPDATE `".$prefix."_nsncb_config` SET `enabled`='$xenabled', `count`='$xcount', `height`='$xheight' WHERE `cgid`='4'");
$result1 = $nuke_db->sql_query("UPDATE `".$prefix."_nsncb_blocks` SET `content`='$x1content', `filename`='$x1name', `title`='$x1title', `wtype`='$x1wtype', `width`='$x1width' WHERE `cbid`='1' AND `cgid`='4'");
$result2 = $nuke_db->sql_query("UPDATE `".$prefix."_nsncb_blocks` SET `content`='$x2content', `filename`='$x2name', `title`='$x2title', `wtype`='$x2wtype', `width`='$x2width' WHERE `cbid`='2' AND `cgid`='4'");
$result3 = $nuke_db->sql_query("UPDATE `".$prefix."_nsncb_blocks` SET `content`='$x3content', `filename`='$x3name', `title`='$x3title', `wtype`='$x3wtype', `width`='$x3width' WHERE `cbid`='3' AND `cgid`='4'");
$result4 = $nuke_db->sql_query("UPDATE `".$prefix."_nsncb_blocks` SET `content`='$x4content', `filename`='$x4name', `title`='$x4title', `wtype`='$x4wtype', `width`='$x4width' WHERE `cbid`='4' AND `cgid`='4'");
/*****[BEGIN]******************************************
...
/*****[END]********************************************
 [ Base:    Caching System                     v1.0.0 ]
 ******************************************************/
nuke_redirect($admin_file.'.php?op=CenterBlocksSet4');
