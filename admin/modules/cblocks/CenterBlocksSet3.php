...
OpenTable();
title(_CB_CONFIG3);
$cbinfo = $nuke_db->sql_fetchrow($nuke_db->sql_query("SELECT * FROM `".$prefix."_nsncb_config` WHERE `cgid`='3'"));
...
sort($cblockslist);
$result2 = $nuke_db->sql_query("SELECT * FROM `".$prefix."_nsncb_blocks` WHERE `cgid`='3' ORDER BY `cbid`");
