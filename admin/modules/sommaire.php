...
global $admin, $keysommaire, $currentlang, $deletecat, $nuke_db, $prefix, $sql, $upgrade_test, $bgcolor1, $zetheme, $admin_file, $admdata, $nuke_cache;
...
global $admin_file, $nuke_cache, $more_js;
 ...
 ******************************************************/
    $nuke_cache->delete('sommaire_row', 'block');
    $nuke_cache->delete('sommaire_row2', 'block');
    $nuke_cache->delete('sommaire_row3', 'block');
    $nuke_cache->delete('sommaire_row4', 'block');
    $nuke_cache->delete('sommaire_tempo', 'block');
/*****[END]********************************************
 [ Base:    Caching System                     v3.0.0 ]
 ******************************************************/    
...
global $admin_file, $more_js;
    global $deletecat, $keysommaire, $confirm, $catname, $nuke_db, $prefix, $nuke_cache;
    if ($confirm<>"YES") {
        include_once(NUKE_BASE_DIR.'header.php');
        OpenTable();
        echo "<div align=\"center\">\n<a href=\"$admin_file.php?op=sommaire\">" . _SOM_ADMIN_HEADER . "</a></div>\n";
