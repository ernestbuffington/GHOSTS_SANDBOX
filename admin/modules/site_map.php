...
global $prefix, $nuke_db, $sitename, $currentlang, $admin_file;
...
';
            ...
            {
            //$nuke_db->sql_query("UPDATE ".$prefix."_jmap SET xml = ".$xml.", nnews = ".$nnews.", ntopics = ".$ntopics.", ndown = ".$ndown.", nrev = ".$nrev.", nuser = ".$nuser);
            $nuke_db->sql_query("UPDATE " . $prefix . "_jmap SET value = '".$xml."' WHERE name = 'xml'");
            $nuke_db->sql_query("UPDATE " . $prefix . "_jmap SET value = '".$nnews."' WHERE name = 'nnews'");
            $nuke_db->sql_query("UPDATE " . $prefix . "_jmap SET value = '".$ntopics."' WHERE name = 'ntopics'");
            $nuke_db->sql_query("UPDATE " . $prefix . "_jmap SET value = '".$ndown."' WHERE name = 'ndown'");
            $nuke_db->sql_query("UPDATE " . $prefix . "_jmap SET value = '".$nrev."' WHERE name = 'nrev'");
            $nuke_db->sql_query("UPDATE " . $prefix . "_jmap SET value = '".$nuser."' WHERE name = 'nuser'");
