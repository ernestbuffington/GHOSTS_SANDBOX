...
$test1 = $nuke_db->sql_query("SELECT * FROM `".$prefix."_nsnst_excluded_ranges` WHERE `ip_lo`<='$longip_lo' AND `ip_hi`>='$longip_lo'");
$test2 = $nuke_db->sql_query("SELECT * FROM `".$prefix."_nsnst_excluded_ranges` WHERE `ip_lo`<='$longip_hi' AND `ip_hi`>='$longip_hi'");
$test3 = $nuke_db->sql_query("SELECT * FROM `".$prefix."_nsnst_excluded_ranges` WHERE `ip_lo`>='$longip_lo' AND `ip_hi`<='$longip_hi'");
$test4 = $nuke_db->sql_query("SELECT * FROM `".$prefix."_nsnst_excluded_ranges` WHERE `ip_lo`<='$longip_lo' AND `ip_hi`>='$longip_hi'");
...
if($testnum1 > 0 OR $testnum2 >0 OR $testnum3 >0 OR $testnum4 >0) {
  ...
  $xtime = time();
  $nuke_db->sql_query("INSERT INTO `".$prefix."_nsnst_excluded_ranges` VALUES ('$longip_lo', '$longip_hi', '$xtime', '$xnotes', '$xc2c')");
  if($another == 1) {
