...
$testnum1 = $nuke_db->sql_numrows($nuke_db->sql_query("SELECT * FROM `".$prefix."_nsnst_referers` WHERE `referer`='".$referer."' AND `rid`!='".$rid."'"));
if($testnum1 > 0) {
  ...
  $nuke_db->sql_query("UPDATE `".$prefix."_nsnst_referers` SET `referer`='".$referer."' WHERE `rid`='".$rid."'");
