...
function adminMain() {
    global $language_nuke, $admin, $aid, $prefix, $file, $nuke_db, $sitename, $nuke_user_prefix, $admin_file, $bgcolor1, $evoconfig, $admdata, $nuke_dbtype, $nuke_cache, $json, $admincookie, $radminsuper;
/*****[BEGIN]******************************************
