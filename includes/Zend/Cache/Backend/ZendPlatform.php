 ...
 * @version    $Id: ZendPlatform.php 16 2010-02-12 00:38:19Z Technocrat $
 */
 ...
 * @see Zend_Cache_Backend_Interface
 */
require_once(NUKE_ZEND_DIR.'Cache/Backend/Interface.php');
    ...
    public function clean($mode = Zend_Cache::CLEANING_MODE_ALL, $tags = array())
    {
        switch ($mode) {
            ...
            case Zend_Cache::CLEANING_MODE_OLD:
                $nuke_cache_dir = ini_get('zend_accelerator.output_cache_dir');
                if (!$nuke_cache_dir) {
                    return false;
                }
                $nuke_cache_dir .= '/.php_cache_api/';
                return $this->_clean($nuke_cache_dir, $mode);
                break;
