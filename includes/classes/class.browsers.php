<?php 
	...
	class Browser {
		...
		//added by Ernest Allebn Buffington  
		const BROWSER_OPR = 'OPR';                                // http://www.opera.com/
		//added by Ernest Allebn Buffington  
		const BROWSER_MAXTHON = 'Maxthon';                        // http://
