...
function sql_query($query, $id="")
{
  global $nuke_db, $debugger;
  $debugger->handle_error("Use of deprecated function <strong>".__FUNCTION__."</strong>");
  return $nuke_db->sql_query($query);
}
...
function sql_num_rows($res)
{
  global $nuke_db, $debugger;
  $debugger->handle_error("Use of deprecated function <strong>".__FUNCTION__."</strong>");
  return $nuke_db->sql_numrows($res);
}
...
function sql_fetch_row(&$res, $nr=0)
{
  global $nuke_db, $debugger;
  $debugger->handle_error("Use of deprecated function <strong>".__FUNCTION__."</strong>");
  return $nuke_db->sql_fetchrow($res);
}
...
function sql_free_result($res) {
  global $nuke_db, $debugger;
  $debugger->handle_error("Use of deprecated function <strong>".__FUNCTION__."</strong>");
  return $nuke_db->sql_freeresult($res);
}
