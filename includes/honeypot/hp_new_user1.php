...
$result1 = $nuke_db->sql_query("SELECT usehp, check1, check2, check3, check4, check3time, check4question, check4answer FROM ".$prefix."_honeypot_config");
list($usehp, $check1, $check2, $check3, $check4, $check3time, $check4question, $check4answer) = $nuke_db->sql_fetchrow($result1);
