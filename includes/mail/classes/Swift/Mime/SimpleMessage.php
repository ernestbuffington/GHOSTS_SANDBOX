  ...
  implements Swift_Mime_Message
{
  ...
  /**
   * Create a new SimpleMessage with $headers, $encoder and $nuke_cache.
  ...
  public function __construct(Swift_Mime_HeaderSet $headers,
    Swift_Mime_ContentEncoder $encoder, Swift_KeyCache $nuke_cache, $charset = null)
  {
    parent::__construct($headers, $encoder, $nuke_cache, $charset);
