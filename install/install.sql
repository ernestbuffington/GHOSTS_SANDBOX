...
(15, 0, 0, 0, 4, 'Member_Cemetery', '', '', 'tree-lightblueT.png', 'on', -1, 'modules', 'on', ''),
...
(34, 'Member_Bookmarks', 'Network Bookmarks', 1, 3, 1, 9, 7, 3, '', 'Array'),
...
(40, 'Member_Cemetery', 'Network Cemetery', 1, 6, 1, 0, 7, 3, '', '4'),
...
CREATE TABLE `nuke_pages` (
  ...
  `nuke_page_header` text NOT NULL,
  `text` text NOT NULL,
  `nuke_page_footer` text NOT NULL,
