...
global $prefix, $ShoutSubmit, $ShoutComment, $nuke_db, $nuke_user, $cookie, $shoutuid, $top_content, $mid_content, $bottom_content, $ShoutMarqueewidth, $ShoutMarqueeheight, $currentlang;
